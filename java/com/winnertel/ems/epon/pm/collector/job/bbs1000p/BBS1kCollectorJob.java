...
public class BBS1kCollectorJob implements Job
{
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException
  {
    ...
    try
    {
      ...
      {
        oids = new String[]{".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.30", ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.31",
                            ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.5", ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.6"};
...
*/
        ...
        for(int i = 0; i < measInstances.size(); i++)
        {
          ...
          oids = new String[]{".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.30." + indices[i], ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.31." + indices[i],
                              ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.5." + indices[i], ".1.3.6.1.4.1.45121.1800.4.2.1.1.6.1.6." + indices[i],
                              ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.5.1.5." + indices[i], ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.5.1.6." + indices[i]};
