 ...
 */
public class SaveCNUConfigAction extends SnmpAction {

    public SaveCNUConfigAction(IApplication anApplication) {
        super(anApplication);
        putValue(BaseAction.ID, "Save_CNU");
    }
    ...
    public void executeAction(ActionEvent e) throws Exception {
        ...
        try {
            ...
            if (!result.booleanValue()) {
                throw new OperationFailedException("Save CNU configuration operation failed");
            }
    ...
    class SaveConfigTask extends Task {
        ...
        public Object execute() throws Exception {
            ...
            return bean.saveCNU() ? Boolean.TRUE : Boolean.FALSE;
        }
