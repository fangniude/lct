 ...
 */
public class ResetCardAction extends SnmpAction {

    public ResetCardAction(IApplication anApplication) {
        super(anApplication);
        putValue(BaseAction.ID, "Reset_Card");
    }
    ...
    public void executeAction(ActionEvent e) throws Exception {
        ...
        try {
            ...
            if (!result.booleanValue()) {
                throw new OperationFailedException("Reset Card operation failed");
            }
    ...
    class ResetCardTask extends Task {
        ...
        public Object execute() throws Exception {
            ...
            return bean.resetCard() ? Boolean.TRUE : Boolean.FALSE;
        }
