...
public class ModifyModEoCCBATCardTableChecker extends BaseChecker {
    public ModifyModEoCCBATCardTableChecker(IApplication app) {
        super(app);
    }
    ...
    public boolean doCheck(SnmpMibBean[] data, SnmpMibBean[] selectedMibBeans) {
        ...
        String infoMessage = fApplication.getActiveDeviceManager().getGuiComposer().getString("Info_Modify_ModEoCCBATCard");
