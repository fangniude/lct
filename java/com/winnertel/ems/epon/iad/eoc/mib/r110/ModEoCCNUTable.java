package com.winnertel.ems.epon.iad.eoc.mib.r110;
 ...
 * Created by QuickDVM
 */
public class ModEoCCNUTable extends SnmpMibBean {
    ...
    protected void init() {
        initProperty(modEoCCNUCBATCardIndex, new SnmpMibBeanProperty(modEoCCNUCBATCardIndex, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.1", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUIndex, new SnmpMibBeanProperty(modEoCCNUIndex, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.2", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUMACAddress, new SnmpMibBeanProperty(modEoCCNUMACAddress, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.3", ISnmpConstant.OCTETS));
        initProperty(modEoCCNUOnlineStatus, new SnmpMibBeanProperty(modEoCCNUOnlineStatus, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.4", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUModelNumber, new SnmpMibBeanProperty(modEoCCNUModelNumber, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.5", ISnmpConstant.STRING));
        initProperty(modEoCCNUPortAmount, new SnmpMibBeanProperty(modEoCCNUPortAmount, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.6", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUAuthorizationState, new SnmpMibBeanProperty(modEoCCNUAuthorizationState, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.7", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUSoftwareVersion, new SnmpMibBeanProperty(modEoCCNUSoftwareVersion, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.8", ISnmpConstant.STRING));
        initProperty(modEoCCNUReset, new SnmpMibBeanProperty(modEoCCNUReset, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.9", ISnmpConstant.INTEGER));
        initProperty(modEoCCNURFAttenuation, new SnmpMibBeanProperty(modEoCCNURFAttenuation, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.10", ISnmpConstant.INTEGER));
        initProperty(modEoCCNURFDownstreamQuality, new SnmpMibBeanProperty(modEoCCNURFDownstreamQuality, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.11", ISnmpConstant.INTEGER));
        initProperty(modEoCCNURFUpstreamQuality, new SnmpMibBeanProperty(modEoCCNURFUpstreamQuality, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.12", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUPhyDownstreamRate, new SnmpMibBeanProperty(modEoCCNUPhyDownstreamRate, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.13", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUPhyUpstreamRate, new SnmpMibBeanProperty(modEoCCNUPhyUpstreamRate, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.14", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUConfigurationSaving, new SnmpMibBeanProperty(modEoCCNUConfigurationSaving, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.15", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUConfigurationResult, new SnmpMibBeanProperty(modEoCCNUConfigurationResult, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.16", ISnmpConstant.INTEGER));
        initProperty(modEoCCNUAction, new SnmpMibBeanProperty(modEoCCNUAction, ".1.3.6.1.4.1.17409.2.4.5.2.4.1.17", ISnmpConstant.INTEGER));
    }
