...
public class Onu2CtcCombinedFeaturesIadResetAction extends SnmpAction {

	public Onu2CtcCombinedFeaturesIadResetAction(IApplication anApplication) {
		super(anApplication);
	}
...
//		}
	...
	class CommitTask extends Task {
		...
		public Object execute() throws Exception {
			...
			mBean.setUtsDot3Onu2CtcIadOperation(2);
