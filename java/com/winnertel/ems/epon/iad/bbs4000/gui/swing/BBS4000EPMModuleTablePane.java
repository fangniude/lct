...
public class BBS4000EPMModuleTablePane extends UPanel implements ActionListener {
  private OnLineEPMSlotFilterPanel modulePanel = null;

  private SnmpTablePane snmpPanel;

  public BBS4000EPMModuleTablePane(IApplication app) {
    super(app);
    init();
  }

  public void initGui() {
    modulePanel = new OnLineEPMSlotFilterPanel(fApplication);
...
//    bean.setRowsToFetch(getRowsToFetch(getName()));
  ...
  private Object[] generateIndex(String panel)
  {
    ...
    if(panel.equals("Dot3Olt2PortTable_Panel") || panel.equals("Dot3Olt2PortDbaTable_Panel") || panel.equals("ONU_Registration") || panel.equals("OnuLoopbackTestTable_Panel") || panel.equals("Dot3Olt2PortDiagnosisTable_Panel"))
    {
