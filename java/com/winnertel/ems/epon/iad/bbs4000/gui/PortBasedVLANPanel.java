...
public class PortBasedVLANPanel extends UPanel {
    ...
    //private int[] utsEponDot1qVlanStpBridgeEnableVList = new int[]{1, 2,};
    ...
    public void initGui() {
        ...
        NTLayout layout1 = new NTLayout(4, 3, NTLayout.FILL, NTLayout.CENTER, 5, 5);
    ...
    protected void initForm() {
        ...
        //tfUtsEponDot1qVlanStpBridgeEnable.setEnabled(false);
    }
    ...
    public void refresh() {
        try {
            ...
            //Only when utsBBSBPDUTermination=2:disable(2), can set utsEponDot1qVlanStpBridgeEnable to 1:enable(1)
            //tfUtsEponDot1qVlanStpBridgeEnable.setEnabled(false);
            ...
            //    tfUtsEponDot1qVlanStpBridgeEnable.setEnabled(true);
            //}
        } catch (Exception ex) {
            ex.printStackTrace();
        }
