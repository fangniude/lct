...
public class UniTrunkGroupManagementPanel extends UPanel {

    SnmpTablePane tablepanel1;
    SnmpTablePane tablepanel2;

    public UniTrunkGroupManagementPanel(IApplication app) {
        super(app);
        init();
    }
    ...
    public void initGui() {
        ...
        tablepanel1 = (SnmpTablePane) composer1.composeSnmpTablePane("UniTrunkGroupConfigTable");
        tablepanel1.setPreferredSize(new Dimension(100, 200));
        tablepanel1.setBorder(BorderFactory.createTitledBorder(fStringMap.getString("UniTrunkGroupConfigTable")));

        IGuiComposer composer2 = fApplication.getActiveDeviceManager().getGuiComposer();
        tablepanel2 = (SnmpTablePane) composer2.composeSnmpTablePane("UniTrunkGroupTable");
        tablepanel2.setPreferredSize(new Dimension(100, 200));
        tablepanel2.setBorder(BorderFactory.createTitledBorder(fStringMap.getString("UniTrunkGroupTable")));
