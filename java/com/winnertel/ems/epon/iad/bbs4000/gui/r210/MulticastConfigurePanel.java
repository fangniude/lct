...
public class MulticastConfigurePanel extends UPanel {
    ...
    private JComboBox tfUtsDot3Onu2MulticastFilter = new JComboBox(multicastFilterTList); // added by Zhou Chao, 2008/8/4
    ...
    protected void initGui() {
        ...
        baseInfoPanel.add(new JLabel(utsDot3Onu2MulticastFilter)); // added by Zhou Chao, 2008/8/4
        tfUtsDot3Onu2MulticastFilter.setName(fStringMap.getString("utsDot3Onu2MulticastFilter")); // added by Zhou Chao, 2008/8/4
        baseInfoPanel.add(tfUtsDot3Onu2MulticastFilter); // added by Zhou Chao, 2008/8/4
        baseInfoPanel.add(new HSpacer()); // added by Zhou Chao, 2008/8/4
