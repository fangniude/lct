...
//    baseInfoPanel.add(new HSpacer());
  ...
  protected void initForm() {
    tfUtsDot3OltPortDbaCycleSize.setValueScope(12500, 1000000);
    tfUtsDot3OltPortDbaDiscoveryFreq.setValueScope(13, 255);
    tfUtsDot3OltPortDbaDiscoverySize.setValueScope(1024, 14000);
  }
