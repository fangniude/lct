...
import com.winnertel.ems.epon.iad.bbs4000.mib.r210.EponModuleBoardTable;
...
//		baseInfoPanel.add(new HSpacer());
	...
	public void refresh()
	{
		...
		if(mbean.getUtsEponModuleBoardPhyId() == 13) {
			tfUtsEponModuleBoardPhyId.setText("A");
		}
		else if(mbean.getUtsEponModuleBoardPhyId() == 14) {
			tfUtsEponModuleBoardPhyId.setText("B");
		}
		else {
