...
public class Dot3Onu2PowerShutdownTemporarilyAction extends SnmpAction {

	public Dot3Onu2PowerShutdownTemporarilyAction(IApplication anApplication) {
		super(anApplication);
	}
	...
	public void executeAction(ActionEvent e) throws OperationFailedException,
		...
		fBean.setUtsDot3Onu2PowerControlActions(new Integer(1));
