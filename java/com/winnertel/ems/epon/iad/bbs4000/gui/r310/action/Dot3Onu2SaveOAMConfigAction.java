...
public class Dot3Onu2SaveOAMConfigAction extends SnmpAction {

	public Dot3Onu2SaveOAMConfigAction(IApplication anApplication) {
		super(anApplication);
	}
	...
	public void executeAction(ActionEvent e) throws OperationFailedException,
		...
		fBean.setUtsDot3Onu2ConfigActions(1);
