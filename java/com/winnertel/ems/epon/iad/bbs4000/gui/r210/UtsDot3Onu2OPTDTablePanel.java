...
import com.winnertel.ems.epon.iad.bbs4000.mib.r210.UtsDot3Onu2OPTDTable;
...
/**
 * The UtsDot3Onu2OPTDTablePanel class. Created by Yang Yizai
 */
public class UtsDot3Onu2OPTDTablePanel extends UPanel {
...
//      + " : ";
  ...
  public UtsDot3Onu2OPTDTablePanel(IApplication app) {
    super(app);
    setModel(new UtsDot3Onu2OPTDTable(app.getSnmpProxy()));
    init();
  }
  ...
  public void initGui() {
    ...
    baseInfoPanel
        .add(new JLabel(utsDot3OnuOpticalTransceiverDiagnosisModuleId));
    baseInfoPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisModuleId);
    baseInfoPanel.add(new HSpacer());

  

    baseInfoPanel.add(new JLabel(utsDot3OnuOpticalTransceiverDiagnosisPortId));
   ...
   baseInfoPanel.add(new HSpacer());
    ...
    tfUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisAlarmOperation"));
    baseInfoPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation);
    baseInfoPanel.add(new HSpacer());
...
//    tempPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisTempLowWarning);
  ...
  public JPanel getVoltagePanel(){
    ...
    voltagePanel.setBorder(BorderFactory.createTitledBorder(fStringMap .getString("voltage")));
    voltagePanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm"));
    voltagePanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm);

    voltagePanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm"));
    voltagePanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm);
...
//    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowWarning.setName(fStringMap
//        .getString("utsDot3OnuOpticalTransceiverDiagnosisVoltageLowWarning"));
//    voltagePanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowWarning);
    return voltagePanel;
  }
...
//    biasPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisBiasLowWarning);
  ...
  public JPanel getTxPowerPanel(){
    ...
    txPowerPanel.setBorder(BorderFactory.createTitledBorder(fStringMap .getString("txPower")));
    
    txPowerPanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm"));
    txPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm);

    txPowerPanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm"));
    txPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm);
...
//    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowWarning.setName(fStringMap
//        .getString("utsDot3OnuOpticalTransceiverDiagnosisTxPowerLowWarning"));
//    txPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowWarning);
    return txPowerPanel;
  ...
  public JPanel getRxPowerPanel(){
    ...
    rxPowerPanel.setBorder(BorderFactory.createTitledBorder(fStringMap .getString("rxPower")));
    rxPowerPanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm"));
    rxPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm);

    rxPowerPanel.add(new JLabel(
        utsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm));
    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm.setName(fStringMap
        .getString("utsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm"));
    rxPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm);
...
//    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowWarning.setName(fStringMap
//        .getString("utsDot3OnuOpticalTransceiverDiagnosisRxPowerLowWarning"));
//    rxPowerPanel.add(tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowWarning);
  ...
  public void refresh() {
    UtsDot3Onu2OPTDTable mbean = (UtsDot3Onu2OPTDTable) getModel();

    tfUtsDot3OnuOpticalTransceiverDiagnosisModuleId.setText(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisModuleId().toString());
    ...
    tfUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation.setSelectedIndex(getIndexFromValue(utsDot3OnuOpticalTransceiverDiagnosisAlarmOperationVList, mbean.getUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation().intValue()));
    tfUtsDot3OnuOpticalTransceiverDiagnosisTempHighAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisTempHighAlarm().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisTempLowAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisTempLowAlarm().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisTempHighWarning.setValue(mbean
//        .getUtsDot3OnuOpticalTransceiverDiagnosisTempHighWarning().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisTempLowWarning.setValue(mbean
//        .getUtsDot3OnuOpticalTransceiverDiagnosisTempLowWarning().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighWarning.setValue(mbean
...
//            .intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisBiasHighAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisBiasHighAlarm().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisBiasLowAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisBiasLowAlarm().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisBiasHighWarning.setValue(mbean
//        .getUtsDot3OnuOpticalTransceiverDiagnosisBiasHighWarning().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisBiasLowWarning.setValue(mbean
//        .getUtsDot3OnuOpticalTransceiverDiagnosisBiasLowWarning().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighWarning.setValue(mbean
...
//            .intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm().intValue());
    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm.setValue(mbean.getUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm().intValue());
//    tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighWarning.setValue(mbean
...
//            .intValue());
  ...
  public void updateModel() {
    ...
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation(new Integer(utsDot3OnuOpticalTransceiverDiagnosisAlarmOperationVList[tfUtsDot3OnuOpticalTransceiverDiagnosisAlarmOperation.getSelectedIndex()]));
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTempHighAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisTempHighAlarm.getValue()*256);
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTempLowAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisTempLowAlarm.getValue()*256);
//    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTempHighWarning(new Integer(
//        tfUtsDot3OnuOpticalTransceiverDiagnosisTempHighWarning.getValue()));
//    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTempLowWarning(new Integer(
//        tfUtsDot3OnuOpticalTransceiverDiagnosisTempLowWarning.getValue()));
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageHighAlarm.getValue()*1000);
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowAlarm.getValue()*1000);
//    mbean
...
//            tfUtsDot3OnuOpticalTransceiverDiagnosisVoltageLowWarning.getValue()));
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisBiasHighAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisBiasHighAlarm.getValue()*1000);
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisBiasLowAlarm(tfUtsDot3OnuOpticalTransceiverDiagnosisBiasLowAlarm.getValue()*1000);
//    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisBiasHighWarning(new Integer(
//        tfUtsDot3OnuOpticalTransceiverDiagnosisBiasHighWarning.getValue()));
//    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisBiasLowWarning(new Integer(
//        tfUtsDot3OnuOpticalTransceiverDiagnosisBiasLowWarning.getValue()));

    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm(format(tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerHighAlarm.getValue()));

    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm(format(tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowAlarm.getValue()));
//    mbean
...
//            tfUtsDot3OnuOpticalTransceiverDiagnosisTxPowerLowWarning.getValue()));
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm(format(tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerHighAlarm.getValue()));
    mbean.setUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm(format(tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowAlarm.getValue()));
//    mbean
...
//            tfUtsDot3OnuOpticalTransceiverDiagnosisRxPowerLowWarning.getValue()));
