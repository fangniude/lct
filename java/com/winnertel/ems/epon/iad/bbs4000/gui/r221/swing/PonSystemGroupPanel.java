...
import com.winnertel.ems.epon.iad.bbs4000.mib.r221.PonSystemGroup;
...
//    private JComboBox tfUtsBBSMgmtONUSNumberSwitch = new JComboBox(utsBBSMgmtONUSNumberSwitchTList);
	...
	private int[] utsDot3OltOpmSwitchVList = new int[] { 0, 1, };
	private String[] utsDot3OltOpmSwitchTList = new String[] {
			fStringMap.getString("disabled"), fStringMap.getString("enabled"), };
//	private JComboBox tfutsDot3OltOpmSwitch = new JComboBox(
//			utsDot3OltOpmSwitchTList);
    ...
    private final String utsDot3OltOpmSwitch = fStringMap.getString("utsDot3OltOpmSwitch") + ": ";
...
//        baseInfoPanel.add(new JLabel(utsDot3OltOpmSwitch));
//        baseInfoPanel.add(tfutsDot3OltOpmSwitch);
//        baseInfoPanel.add(new HSpacer());
...
//        tfutsDot3OltOpmSwitch.setSelectedIndex(getIndexFromValue(utsDot3OltOpmSwitchVList, mbean.getUtsDot3OltOpmSwitch()));
    }
...
//        mbean.setUtsDot3OltOpmSwitch(utsDot3OltOpmSwitchVList[tfutsDot3OltOpmSwitch.getSelectedIndex()]);
    }
