...
import com.winnertel.ems.epon.iad.bbs4000.mib.QosExtIpPrecDscpMapTable;
...
//  private final String utsMLSQosExtIpPrecDscpMapIntfIndex = fStringMap.getString("utsMLSQosExtIpPrecDscpMapIntfIndex") + " : ";
	private final String utsMLSQosExtIpPrecDscpMapIpPrecVal = fStringMap
			.getString("utsMLSQosExtIpPrecDscpMapIpPrecVal")
			+ " : ";
	private final String utsMLSQosExtIpPrecDscpMapDscpVal = fStringMap
...
//    tfUtsMLSQosExtIpPrecDscpMapIntfIndex.setText(SwitchInterfaceIndexFormatter.format(mbean.getUtsMLSQosExtIpPrecDscpMapIntfIndex()));
		tfUtsMLSQosExtIpPrecDscpMapIpPrecVal.setText(mbean
				.getUtsMLSQosExtIpPrecDscpMapIpPrecVal().toString());
		tfUtsMLSQosExtIpPrecDscpMapDscpVal.setValue(mbean
				.getUtsMLSQosExtIpPrecDscpMapDscpVal().intValue());
	}
	...
	public void updateModel()
	{
		...
		mbean.setUtsMLSQosExtIpPrecDscpMapDscpVal(new Integer(
				tfUtsMLSQosExtIpPrecDscpMapDscpVal.getValue()));
	}
}
