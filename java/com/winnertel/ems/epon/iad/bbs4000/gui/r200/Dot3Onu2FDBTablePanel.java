...
public class Dot3Onu2FDBTablePanel extends UPanel {
  ...
  private JComboBox tfUtsDot3OnuFDBModuleId = new JComboBox();

//  private JComboBox tfUtsDot3OnuFDBDeviceId = new JComboBox();

  private String[] list = new String[]{"1", "2", "3", "4"};
  private JComboBox tfUtsDot3OnuFDBPortId = new JComboBox(list);
...
//  private final String utsDot3OnuFDBDeviceId = fStringMap.getString("utsDot3OnuFDBDeviceId") + " : ";
  ...
  public void initGui() {
    ...
    tfUtsDot3OnuFDBModuleId.addItem(slot);
    tfUtsDot3OnuFDBModuleId.setEnabled(false);
...
//    baseInfoPanel.add(new HSpacer());
    ...
    for (int i = 1; i <= count; i++) {
      tfUtsDot3OnuFDBLPortId.addItem("" + i);
    }
...
//    }
  ...
  public void updateModel() {
    ...
    if (SnmpAction.IType.ADD.equals(fCommand)) {
      mbean.setUtsDot3OnuFDBModuleId(new Integer((String)tfUtsDot3OnuFDBModuleId.getSelectedItem()));
      mbean.setUtsDot3OnuFDBDeviceId(new Integer(1));
      mbean.setUtsDot3OnuFDBPortId(new Integer((String)tfUtsDot3OnuFDBPortId.getSelectedItem()));
      mbean.setUtsDot3OnuFDBLPortId(new Integer((String)tfUtsDot3OnuFDBLPortId.getSelectedItem()));
