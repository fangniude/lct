...
import com.winnertel.ems.epon.iad.bbs4000.mib.r200.Dot3Onu2QoSTable;
...
/**
 * The Dot3Onu2QoSTablePanel class.
...
//  private JComboBox tfUtsDot3OnuAclClassifiEnable = new JComboBox(utsDot3OnuAclClassifiEnableTList);
  ...
  //value: 0 - 7
  private String[] utsDot3OnuQueueMapVList = null;
...
//  private int[] utsDot3OnuShaperActionVList = new int[]{
//    3, 2, 1, };
...
//    baseInfoPanel.add(new HSpacer());
    ...
    utsDot3OnuQueueMapVList = new String[8];
