...
public class DHCPGeneralPanel extends UPanel {
    ...
    public void refresh() {
        ...
        tfUtsDHCPServiceState.setSelectedIndex(getIndexFromValue(utsDHCPServiceStateVList, mbean.getUtsDHCPServiceState()
                .intValue()));
...
//        }
    ...
    public void updateModel() {
        ...
        mbean.setUtsDHCPServiceState(new Integer(utsDHCPServiceStateVList[tfUtsDHCPServiceState
                .getSelectedIndex()]));
        mbean.setUtsDHCPServiceMode(new Integer(utsDHCPServiceModeVList[tfUtsDHCPServiceMode
                .getSelectedIndex()]));
    }
