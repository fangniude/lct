...
import com.winnertel.ems.epon.iad.bbs4000.mib.r200.GeneralConfiguration;
...
//    tfUtsBBSOnuByteErrorWindow.setName(fStringMap
//        .getString("utsBBSOnuByteErrorWindow"));
//    baseInfoPanel.add(tfUtsBBSOnuByteErrorWindow);
//    baseInfoPanel.add(new HSpacer());
//
//    baseInfoPanel.add(new JLabel(utsBBSOnuByteErrorThresholdMin));
//    tfUtsBBSOnuByteErrorThresholdMin.setName(fStringMap
//        .getString("utsBBSOnuByteErrorThresholdMin"));
...
//    tfUtsBBSOnuByteErrorWindow.setValue(mbean.getUtsBBSOnuByteErrorWindow().intValue());
//    tfUtsBBSOnuByteErrorThresholdMin.setValue(mbean.getUtsBBSOnuByteErrorThresholdMin().intValue());
...
//    mbean.setUtsBBSOnuByteErrorWindow(new Integer(tfUtsBBSOnuByteErrorWindow.getValue()));
//    mbean.setUtsBBSOnuByteErrorThresholdMin(new Integer(tfUtsBBSOnuByteErrorThresholdMin.getValue()));
