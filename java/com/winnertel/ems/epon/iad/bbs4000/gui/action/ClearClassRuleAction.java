 ...
 */
public class ClearClassRuleAction extends SnmpAction {
  public ClearClassRuleAction(IApplication anApplication) {
    super(anApplication);
  }
  ...
  public void executeAction(ActionEvent e) throws OperationFailedException, OperationCanceledException, OperationFinishedWithoutLogException {
    ...
    if (!MessageDialog.showConfirmOperationDialog(fApplication)) {
      throw new OperationCanceledException("Clear Classification Rule action canceled");
    }
    ...
    // delete the row
    Task t = new ClearClassRuleTask(fTable);
...
//            MessageDialog.showOperationSucceedDialog( fApplication );
      ...
      {
        throw new OperationFailedException("Clear Classification Rule operation failed");
      }
...
class ClearClassRuleTask extends Task {
  SnmpTable fTable = null;

  public ClearClassRuleTask(SnmpTable table) {
    fTable = table;
  }
  ...
  public Object execute() throws Exception {
    ...
    return bean.clearClassifiRule() ? Boolean.TRUE : Boolean.FALSE;
  }
}