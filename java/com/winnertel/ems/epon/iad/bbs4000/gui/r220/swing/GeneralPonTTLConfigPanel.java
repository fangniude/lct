...
public class GeneralPonTTLConfigPanel extends UPanel {
    ...
    private JComboBox tfUtsBBSDosCtrlIcmpCheck = new JComboBox(utsBBSDosCtrlIcmpCheckTList);
    ...
    private JComboBox tfUtsBbsMacStationMoveSwitch = new JComboBox(utsBbsMacStationMoveSwitchTList);
    ...
    private final String utsBBSDosCtrlIcmpCheck = fStringMap.getString("utsBBSDosCtrlIcmpCheck") + ": "; //added by Zhou Chao, 2009/1/15 (only for BBS4000 v2.1.0)
    private final String utsBBS4000R21DosCtrlIcmpPayloadSize = fStringMap.getString("utsBBS4000R21DosCtrlIcmpPayloadSize") + ": "; //added by Zhou Chao, 2009/1/15 (only for BBS4000 v2.1.0)
    private final String utsBbsMacStationMoveSwitch = fStringMap.getString("utsBbsMacStationMoveSwitch") + ": "; //added by Zhou Chao, 2010/4/28 (only for BBS4000 v2.2.0)
    ...
    protected void initGui() {
        ...
        tfUtsBBSMgmtIGMProxySourceInnerVLAN.setName(fStringMap.getString("utsBBSMgmtIGMProxySourceInnerVLAN"));
        generalPanel.add(tfUtsBBSMgmtIGMProxySourceInnerVLAN);
        generalPanel.add(new HSpacer());

        generalPanel.add(new JLabel(utsBBSMgmtIGMProxySourceOuterVLAN));
        tfUtsBBSMgmtIGMProxySourceOuterVLAN.setName(fStringMap.getString("utsBBSMgmtIGMProxySourceOuterVLAN"));
        generalPanel.add(tfUtsBBSMgmtIGMProxySourceOuterVLAN);
        generalPanel.add(new HSpacer());

        generalPanel.add(new JLabel(utsBbsMacStationMoveSwitch));
        tfUtsBbsMacStationMoveSwitch.setName(fStringMap.getString("utsBbsMacStationMoveSwitch"));
    ...
    public void refresh() {
        ...
        tfUtsBbsMacStationMoveSwitch.setSelectedIndex(getIndexFromValue(utsBbsMacStationMoveSwitchVList, mbean.getUtsBbsMacStationMoveSwitch()));
    ...
    public void updateModel() {
        ...
        mbean.setUtsBbsMacStationMoveSwitch(utsBbsMacStationMoveSwitchVList[tfUtsBbsMacStationMoveSwitch.getSelectedIndex()]);
