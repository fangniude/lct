...
public class Dot3RogueOnu2PowerShutdownPermanentlyAction extends SnmpAction {

	public Dot3RogueOnu2PowerShutdownPermanentlyAction(IApplication anApplication) {
		super(anApplication);
	}
