...
/**
 * The Dot3OnuSwitchTablePanel class.
...
public class Dot3OnuSwitchTablePanel extends UPanel {
  ...
  private JComboBox tfUtsDot3OnuSwitchPortId = new JComboBox(new String[]{"1", "2", "3", "4"});
  ...
  public void refresh() {
    ...
    if (SnmpAction.IType.ADD.equals(fCommand)) {
      ...
      for (int i = 0; i < list.size(); i++) {
          ...
          com.winnertel.ems.epon.iad.bbs4000.gui.shelfview.ModuleType fModuleType = new com.winnertel.ems.epon.iad.bbs4000.gui.shelfview.ModuleType();
      ...
      tfUtsDot3OnuSwitchLlid.removeAllItems();
      for(int i = 1; i <= 32; i++)
