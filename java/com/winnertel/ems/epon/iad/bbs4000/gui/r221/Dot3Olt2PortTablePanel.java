...
import com.winnertel.ems.epon.iad.bbs4000.mib.r221.Dot3Olt2PortTable;
...
public class Dot3Olt2PortTablePanel extends UPanel {
    ...
    /*
    private int[] utsDot3OltRxFECEnableVList = new int[]{1, 2,};
...
//    private JComboBox tfUtsDot3OltPortONUSNumberSwitch = new JComboBox(utsDot3OltPortONUSNumberSwitchTList);
    private int[] utsDot3OltPortONUAuthModeVList = new int[]{1, 2, 3};
    private String[] utsDot3OltPortONUAuthModeTList = new String[]{
            fStringMap.getString("mac"), fStringMap.getString("loid"), fStringMap.getString("hybrid")};
...
//        tfUtsDot3OltPortONUSNumberSwitch.setSelectedIndex(getIndexFromValue(utsDot3OltPortONUSNumberSwitchVList, mbean.getUtsDot3OltPortONUSNumberSwitch().intValue()));
        tfUtsDot3OltPortONUAuthMode.setSelectedIndex(getIndexFromValue(utsDot3OltPortONUAuthModeVList, mbean.getUtsDot3OltPortONUAuthMode().intValue()));
    }
    ...
    public void updateModel() {
        ...
        if (mbean.getUtsDot3OltAdminStatus().intValue() == 1 && utsDot3OltAdminStatusVList[tfUtsDot3OltAdminStatus.getSelectedIndex()] == 2) {
            try {
...
//        }
        mbean.setUtsDot3OltPortONUAuthMode(new Integer(utsDot3OltPortONUAuthModeVList[tfUtsDot3OltPortONUAuthMode.getSelectedIndex()]));
    }
