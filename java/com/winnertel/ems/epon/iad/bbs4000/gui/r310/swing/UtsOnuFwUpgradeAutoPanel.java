...
import com.winnertel.ems.epon.iad.bbs4000.mib.r310.UtsOnuFWUpgradeAutoBean;
...
public class UtsOnuFwUpgradeAutoPanel extends UPanel {
    ...
    private String[] utsOnuFWUpgradeAutoOptionTList = new String[] { fStringMap.getString("normal"), // 1
	    fStringMap.getString("force"), // 2
    };
    private JComboBox tfUtsOnuFWUpgradeAutoOption = new JComboBox(utsOnuFWUpgradeAutoOptionTList);

    // private StringTextField tfUtsOnuFWUpgradeAutoCurrentStatus = new StringTextField();

    private final String utsOnuFWUpgradeAutoOption = fStringMap.getString("utsOnuFWUpgradeAutoOption") + " : ";
    // private final String utsOnuFWUpgradeAutoCurrentStatus = fStringMap.getString("utsOnuFWUpgradeAutoCurrentStatus") + " : ";
    private final String utsOnuFWUpgradeAutoPortListBitMap = fStringMap.getString("utsOnuFWUpgradeAutoPortListBitMap") + " : ";
	...
	tfUtsOnuFWUpgradeAutoOption.setName(fStringMap.getString("utsOnuFWUpgradeAutoOption"));
	...
	mbean.setUtsOnuFWUpgradeAutoOption(utsOnuFWUpgradeAutoOptionVList[tfUtsOnuFWUpgradeAutoOption.getSelectedIndex()]);
