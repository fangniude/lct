...
public class Dot3Onu2StaticFDBTablePanel extends UPanel {
  ...
  private JComboBox tfUtsDot3OnuStaticFDBModuleId = new JComboBox();

//  private JComboBox tfUtsDot3OnuStaticFDBDeviceId = new JComboBox();

  private String[] list = new String[]{"1", "2", "3", "4"};
  private JComboBox tfUtsDot3OnuStaticFDBPortId = new JComboBox(list);
...
//  private final String utsDot3OnuStaticFDBDeviceId = fStringMap.getString("utsDot3OnuStaticFDBDeviceId") + " : ";
  ...
  public void initGui() {
    ...
    tfUtsDot3OnuStaticFDBModuleId.addItem(slot);
    tfUtsDot3OnuStaticFDBModuleId.setEnabled(false);
...
//    baseInfoPanel.add(new HSpacer());
    ...
    for (int i = 1; i <= count; i++) {
      tfUtsDot3OnuStaticFDBLPortId.addItem("" + i);
    }
...
//    }
  ...
  public void updateModel() {
    ...
    if (SnmpAction.IType.ADD.equals(fCommand)) {
      mbean.setUtsDot3OnuStaticFDBModuleId(new Integer((String)tfUtsDot3OnuStaticFDBModuleId.getSelectedItem()));
      mbean.setUtsDot3OnuStaticFDBDeviceId(new Integer(1));
      mbean.setUtsDot3OnuStaticFDBPortId(new Integer((String)tfUtsDot3OnuStaticFDBPortId.getSelectedItem()));
      mbean.setUtsDot3OnuStaticFDBLPortId(new Integer((String)tfUtsDot3OnuStaticFDBLPortId.getSelectedItem()));
    }
