...
import com.winnertel.ems.epon.iad.bbs4000.mib.QosExtDscpMutMapTable;
...
//    tfUtsMLSQosExtDscpMutMapIntfIndex.setText(SwitchInterfaceIndexFormatter.format(mbean.getUtsMLSQosExtDscpMutMapIntfIndex()));
		tfUtsMLSQosExtDscpMutMapDscpVal.setText(mbean
				.getUtsMLSQosExtDscpMutMapDscpVal().toString());
		tfUtsMLSQosExtDscpMutMapMutVal.setValue(mbean
				.getUtsMLSQosExtDscpMutMapMutVal().intValue());
	}
	...
	public void updateModel()
	{
		...
		mbean.setUtsMLSQosExtDscpMutMapMutVal(new Integer(
				tfUtsMLSQosExtDscpMutMapMutVal.getValue()));
	}
}
