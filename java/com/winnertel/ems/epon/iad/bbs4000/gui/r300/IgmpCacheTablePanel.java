...
import com.winnertel.ems.epon.iad.bbs4000.mib.r300.IgmpCacheTable;
...
public class IgmpCacheTablePanel extends UPanel
{
	...
	private IPAddressField tfUtsIgmpCacheSourceAddress = new IPAddressField( IPAddressField.IPMULTICAST );
...
//			utsIgmpCacheStatusTList);
	...
	private final String utsIgmpCacheGroupAddress = fStringMap
			...
			+ " : ";
	private final String utsIgmpCacheSourceAddress = fStringMap
	.getString("utsIgmpCacheSourceAddress")
	+ " : ";
...
//			+ " : ";
	...
	public void initGui()
	{
		...
		baseInfoPanel.add(new JLabel(utsIgmpCacheSourceAddress));
		tfUtsIgmpCacheSourceAddress.setValue( "224.0.2.0" );
		tfUtsIgmpCacheSourceAddress.setPreferredSize( new Dimension(100,25));
		baseInfoPanel.add(tfUtsIgmpCacheSourceAddress);
		baseInfoPanel.add(new HSpacer());
	...
	public void updateModel()
	{
		...
		IgmpCacheTable mbean = (IgmpCacheTable) getModel();
		 ...
		 // here set the value of index
			 ...
			 mbean.setUtsIgmpCacheSourceAddress( tfUtsIgmpCacheSourceAddress.getIPString() );
