...
public class EnableDot3OnuPmSwitchAction extends SnmpAction{
	
	public EnableDot3OnuPmSwitchAction(IApplication anApplication) {
		super(anApplication);
	}
	...
	public void executeAction(ActionEvent arg0) throws Exception {
		...
		bean.setUtsDot3OnuOpticalTransceiverDiagnosisPmSwitch( 1 );
