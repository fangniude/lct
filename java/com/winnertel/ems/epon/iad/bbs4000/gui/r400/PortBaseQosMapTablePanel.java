...
import com.winnertel.ems.epon.iad.bbs4000.mib.r400.PortBaseQosMapTable;
...
public class PortBaseQosMapTablePanel extends UPanel {
    ...
    private final String baseQosMapRuleIndex = fStringMap.getString("portBaseQosMapRuleIndex") + " : ";
    private final String baseQosMapOctet = fStringMap.getString("portBaseQosMapOctet") + " : ";

    public PortBaseQosMapTablePanel(IApplication app) {
        super(app);
        init();
    }
    ...
    public void refresh() {
        PortBaseQosMapTable mbean = (PortBaseQosMapTable) getModel();
        if (mbean == null)
            return;

        tfBaseQosMapRuleIndex.setSelectedIndex(getIndexFromValue(baseQosMapRuleIndexVList, mbean.getPortBaseQosMapRuleIndex()));
        //selectBaseQosMaoOctetPanel(mbean.getPortBaseQosMapRuleIndex()); //manually trigger 'addItemListener'
        setBaseQosMapOctet(mbean.getPortBaseQosMapRuleIndex(), mbean.getPortBaseQosMapOctet());
    }
    ...
    public void updateModel() {
        ...
        mbean.setPortBaseQosMapOctet(getBaseQosMapOctet(mbean.getPortBaseQosMapRuleIndex()));
    }
