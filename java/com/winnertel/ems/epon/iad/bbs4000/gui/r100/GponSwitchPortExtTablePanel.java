...
public class GponSwitchPortExtTablePanel extends UPanel implements ActionListener {

    private OnLineSlotFilterPanel modulePanel = null;

    private SnmpTablePane snmpPanel;

    public GponSwitchPortExtTablePanel(IApplication app) {
        super(app);
    ...
    public void initGui() {
        ...
        snmpPanel = (SnmpTablePane) composer1.composeSnmpTablePane("SwitchPortExtTable_Panel");
...
//    qosTablePanel.refresh();
    ...
    public void actionPerformed(ActionEvent e) {
        SwitchPortExtTable bean = (SwitchPortExtTable) snmpPanel.getModel();
