...
import com.winnertel.ems.epon.iad.bbs4000.mib.r300.IntfRateControlGEMTable;
...
public class IntfRateControlGEMTablePanel extends UPanel {
    ...
    //private int[] utsIntfRateControlUplinkSpeedVList = new int[]{100, 1000, 10,};
    ...
    private String[] utsIntfRateControlUplinkDuplexStatusTList = new String[]{
            fStringMap.getString("full-duplex"),
            fStringMap.getString("half-duplex"),
    };
    ...
    private final String utsIntfRateControlId = fStringMap.getString("utsIntfRateControlId") + " : ";
    ...
    public void refresh() {
        ...
        tfUtsIntfRateControlMcastEnable.setSelectedIndex(getIndexFromValue(utsIntfRateControlMcastEnableVList, mbean.getUtsIntfRateControlMcastEnable().intValue()));
        tfUtsIntfRateControlMcastLimit.setValue(mbean.getUtsIntfRateControlMcastLimit().intValue());
        tfUtsIntfRateControlBcastEnable.setSelectedIndex(getIndexFromValue(utsIntfRateControlBcastEnableVList, mbean.getUtsIntfRateControlBcastEnable().intValue()));
        tfUtsIntfRateControlBcastLimit.setValue(mbean.getUtsIntfRateControlBcastLimit().intValue());
        tfUtsIntfRateControlUnicastEnable.setSelectedIndex(getIndexFromValue(utsIntfRateControlUnicastEnableVList, mbean.getUtsIntfRateControlUnicastEnable().intValue()));
        tfUtsIntfRateControlUnicastLimit.setValue(mbean.getUtsIntfRateControlUnicastLimit().intValue());
        tfUtsIntfRateLimitIngressBandwidth.setValue(mbean.getUtsIntfRateLimitIngressBandwidth().intValue());
        tfUtsIntfRateLimitEgressBandwidth.setValue(mbean.getUtsIntfRateLimitEgressBandwidth().intValue());
        tfUtsIntfRateControlIsolationCtrl.setSelectedIndex(getIndexFromValue(utsIntfRateControlIsolationCtrlVList, mbean.getUtsIntfRateControlIsolationCtrl().intValue()));
        tfUtsIntfRateControlIsolationCtrl.setEnabled(false);
        //tfUtsIntfRateControlUplinkSpeed.setSelectedIndex(getIndexFromValue(utsIntfRateControlUplinkSpeedVList, mbean.getUtsIntfRateControlUplinkSpeed().intValue()));
        tfUtsIntfRateControlVlanIngressFilter.setSelectedIndex(getIndexFromValue(utsIntfRateControlVlanIngressFilterVList, mbean.getUtsIntfRateControlVlanIngressFilter().intValue()));
        tfUtsIntfRateControlAutoNegotiation.setSelectedIndex(getIndexFromValue(utsIntfRateControlAutoNegotiationVList, mbean.getUtsIntfRateControlAutoNegotiation().intValue()));
        tfUtsIntfRateLimitIngressBurstSize.setSelectedIndex(getIndexFromValue(utsIntfRateLimitIngressBurstSizeVList, mbean.getUtsIntfRateLimitIngressBurstSize().intValue()));
        tfUtsIntfRateLimitEgressBurstSize.setSelectedIndex(getIndexFromValue(utsIntfRateLimitEgressBurstSizeVList, mbean.getUtsIntfRateLimitEgressBurstSize().intValue()));
        tfUtsIntfRateControlUplinkDuplexStatus.setSelectedIndex(getIndexFromValue(utsIntfRateControlUplinkDuplexStatusVList, mbean.getUtsIntfRateControlUplinkDuplexStatus().intValue()));
        tfUtsIntfRateControlUplinkPortMode.setSelectedIndex(getIndexFromValue(utsIntfRateControlUplinkPortModeVList, mbean.getUtsIntfRateControlUplinkPortMode().intValue()));
    }

    public void updateModel() {
        IntfRateControlGEMTable mbean = (IntfRateControlGEMTable) getModel();

        mbean.setUtsIntfRateControlMcastEnable(new Integer(utsIntfRateControlMcastEnableVList[tfUtsIntfRateControlMcastEnable.getSelectedIndex()]));
        mbean.setUtsIntfRateControlMcastLimit(new Integer(tfUtsIntfRateControlMcastLimit.getValue()));
        mbean.setUtsIntfRateControlBcastEnable(new Integer(utsIntfRateControlBcastEnableVList[tfUtsIntfRateControlBcastEnable.getSelectedIndex()]));
        mbean.setUtsIntfRateControlBcastLimit(new Integer(tfUtsIntfRateControlBcastLimit.getValue()));
        mbean.setUtsIntfRateControlUnicastEnable(new Integer(utsIntfRateControlUnicastEnableVList[tfUtsIntfRateControlUnicastEnable.getSelectedIndex()]));
        ...
        //mbean.setUtsIntfRateControlUplinkSpeed(new Integer(utsIntfRateControlUplinkSpeedVList[tfUtsIntfRateControlUplinkSpeed.getSelectedIndex()]));
        mbean.setUtsIntfRateControlVlanIngressFilter(new Integer(utsIntfRateControlVlanIngressFilterVList[tfUtsIntfRateControlVlanIngressFilter.getSelectedIndex()]));
        ...
        mbean.setUtsIntfRateControlUplinkPortMode(new Integer(utsIntfRateControlUplinkPortModeVList[tfUtsIntfRateControlUplinkPortMode.getSelectedIndex()]));
    }
