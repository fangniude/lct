...
import com.winnertel.ems.epon.iad.bbs4000.mib.r210.EthSmartQinQTable;
  ...
  public void refresh() {
    ...
    if(v != null)
    {
      for(int i = 0; i < v.size(); i++)
      {
        ...
        if(fApplication.getActiveDeviceManager().getVersion().startsWith("1.")){//version of gpon start with "1.x.x"
