...
public class Onu2CtcMduSnmpConfTablePanel extends UPanel {
    ...
    private StringTextField tfUtsDot3Onu2CtcMduSnmpConfTrapHost = new StringTextField();
    ...
    public void updateModel() {
        ...
        mbean.setUtsDot3Onu2CtcMduSnmpConfTrapHost(new String(tfUtsDot3Onu2CtcMduSnmpConfTrapHost.getValue()));
