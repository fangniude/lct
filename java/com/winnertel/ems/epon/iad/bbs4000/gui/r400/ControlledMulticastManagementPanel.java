...
public class ControlledMulticastManagementPanel extends UPanel {

    SnmpTablePane tablepanel1;
    SnmpTablePane tablepanel2;

    public ControlledMulticastManagementPanel(IApplication app) {
        super(app);
        init();
    }
    ...
    public void initGui() {
        ...
        tablepanel1 = (SnmpTablePane) composer1.composeSnmpTablePane("Controlled_Multicast_User_Authority");
        tablepanel1.setPreferredSize(new Dimension(100, 200));
        tablepanel1.setBorder(BorderFactory.createTitledBorder(fStringMap.getString("Controlled_Multicast_User_Authority")));

        IGuiComposer composer2 = fApplication.getActiveDeviceManager().getGuiComposer();
        tablepanel2 = (SnmpTablePane) composer2.composeSnmpTablePane("Controlled_Multicast_Package");
        tablepanel2.setPreferredSize(new Dimension(100, 200));
        tablepanel2.setBorder(BorderFactory.createTitledBorder(fStringMap.getString("Controlled_Multicast_Package")));
