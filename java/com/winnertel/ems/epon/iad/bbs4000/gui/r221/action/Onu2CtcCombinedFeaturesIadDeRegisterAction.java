...
public class Onu2CtcCombinedFeaturesIadDeRegisterAction extends SnmpAction {

	public Onu2CtcCombinedFeaturesIadDeRegisterAction(IApplication anApplication) {
		super(anApplication);
	}
...
//			throw new OperationCanceledException("Deregister from softswitch");
//		}
		...
		try {
			...
			if (!result.booleanValue()) {
				throw new OperationFailedException(
						"Deregister from softswitch failed");
			}
		} catch (Exception ex) {
	...
	class CommitTask extends Task {
		...
		public Object execute() throws Exception {
			...
			mBean.setUtsDot3Onu2CtcIadOperation(1);
