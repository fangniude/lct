...
import com.winnertel.ems.epon.iad.bbs4000.mib.r220.GeneralPonTTLConfig;
...
public class GeneralPonTTLConfigPanel extends UPanel {
	...
	private String[] tList = new String[] { fStringMap.getString("disabled"),
	...
	private String[] utsBBSVlanVPNPRISourceTList = new String[] {
			fStringMap.getString("customertag"), fStringMap.getString("llid"), };
	...
	private final String utsBBSMaxFrameSize = fStringMap
			...
			+ ": ";
	private final String utsBBSMgmtGratuitousArpLearning = fStringMap
			.getString("utsBBSMgmtGratuitousArpLearning")
			+ ": ";
...
//	private IntegerTextField tfUtsBBSMgmtIGMProxySourceOuterVLAN = new IntegerTextField();
	...
	private int[] utsBBSDosCtrlIcmpCheckVList = new int[] { 1, 2, };
	private String[] utsBBSDosCtrlIcmpCheckTList = new String[] {
			fStringMap.getString("enabled"), fStringMap.getString("disabled"), };
	private JComboBox tfUtsBBSDosCtrlIcmpCheck = new JComboBox(
			utsBBSDosCtrlIcmpCheckTList);

	private IntegerTextField tfUtsBBS4000R21DosCtrlIcmpPayloadSize = new IntegerTextField();

	private int[] utsBbsMacStationMoveSwitchVList = new int[] { 1, 2, };
	private String[] utsBbsMacStationMoveSwitchTList = new String[] {
			fStringMap.getString("enabled"), fStringMap.getString("disabled"), };
	private JComboBox tfUtsBbsMacStationMoveSwitch = new JComboBox(
			utsBbsMacStationMoveSwitchTList);

	private final String utsBBSMgmtArpLearning = fStringMap
			.getString("utsBBSMgmtArpLearning")
			+ ": ";
	private final String utsBBSMgmtIgmpProxySourceIP = fStringMap
			.getString("utsBBSMgmtIgmpProxySourceIP")
			+ ": ";
//	private final String utsBBSMgmtIGMProxySourceInnerVLAN = fStringMap
//			.getString("utsBBSMgmtIGMProxySourceInnerVLAN")
//			+ ": ";
//	private final String utsBBSMgmtIGMProxySourceOuterVLAN = fStringMap
//			.getString("utsBBSMgmtIGMProxySourceOuterVLAN")
//			+ ": ";
	private final String utsBBSDosCtrlIcmpCheck = fStringMap
			.getString("utsBBSDosCtrlIcmpCheck")
			+ ": "; // added by Zhou Chao, 2009/1/15 (only for BBS4000 v2.1.0)
	private final String utsBBS4000R21DosCtrlIcmpPayloadSize = fStringMap
			.getString("utsBBS4000R21DosCtrlIcmpPayloadSize")
			+ ": "; // added by Zhou Chao, 2009/1/15 (only for BBS4000 v2.1.0)
	private final String utsBbsMacStationMoveSwitch = fStringMap
			.getString("utsBbsMacStationMoveSwitch")
			+ ": "; // added by Zhou Chao, 2010/4/28 (only for BBS4000 v2.2.0)

	private IntegerTextField tfUtsBBSMgmtTrafficTTL = new IntegerTextField();
	private final String utsBBSMgmtTrafficTTL = fStringMap
			.getString("utsBBSMgmtTrafficTTL")
			+ ": ";
	...
	protected void initGui() {
		...
		tfUtsBBSMgmtArpLearning.setName(fStringMap
				.getString("utsBBSMgmtArpLearning"));
		...
		tfUtsBBSMgmtGratuitousArpLearning.setName(fStringMap
				.getString("utsBBSMgmtGratuitousArpLearning"));
		generalPanel.add(tfUtsBBSMgmtGratuitousArpLearning);
		generalPanel.add(new HSpacer());

		generalPanel.add(new JLabel(utsBBSMgmtIgmpProxySourceIP));
		tfUtsBBSMgmtIgmpProxySourceIP.setName(fStringMap
				.getString("utsBBSMgmtIgmpProxySourceIP"));
		generalPanel.add(tfUtsBBSMgmtIgmpProxySourceIP);
		generalPanel.add(new HSpacer());

//		generalPanel.add(new JLabel(utsBBSMgmtIGMProxySourceInnerVLAN));
//		tfUtsBBSMgmtIGMProxySourceInnerVLAN.setName(fStringMap
//				.getString("utsBBSMgmtIGMProxySourceInnerVLAN"));
//		generalPanel.add(tfUtsBBSMgmtIGMProxySourceInnerVLAN);
//		generalPanel.add(new HSpacer());

//		generalPanel.add(new JLabel(utsBBSMgmtIGMProxySourceOuterVLAN));
//		tfUtsBBSMgmtIGMProxySourceOuterVLAN.setName(fStringMap
//				.getString("utsBBSMgmtIGMProxySourceOuterVLAN"));
//		generalPanel.add(tfUtsBBSMgmtIGMProxySourceOuterVLAN);
//		generalPanel.add(new HSpacer());

		generalPanel.add(new JLabel(utsBbsMacStationMoveSwitch));
		tfUtsBbsMacStationMoveSwitch.setName(fStringMap
				.getString("utsBbsMacStationMoveSwitch"));
		generalPanel.add(tfUtsBbsMacStationMoveSwitch);
		generalPanel.add(new HSpacer());

		generalPanel.setBorder(BorderFactory.createTitledBorder(fStringMap
				.getString("General_Configuration")));
...
//		tfUtsBBSMgmtIGMProxySourceOuterVLAN.setValueScope(0, 4094);
	...
	public boolean validateFrom() {
		...
		if (sysMacAgingTime != 0
				&& !(sysMacAgingTime >= 10 && sysMacAgingTime <= 65535)) {
			String error = fStringMap
					.getString("Err_MAC_Aging_Time_Is_Invalid");
	...
	public void refresh() {
		...
		tfUtsBBSBPDUTermination.setSelectedIndex(getIndexFromValue(vList, mbean
				.getUtsBBSBPDUTermination()));
		tfUtsBBSSysSoftwareRateLimiting.setSelectedIndex(getIndexFromValue(
				vList, mbean.getUtsBBSSysSoftwareRateLimiting()));
		...
		tfUtsBBSVlanVPNTPID.setValue(Integer.toHexString(mbean
				.getUtsBBSVlanVPNTPID()));
		tfUtsBBSVlanVPNPRISource
				.setSelectedIndex(getIndexFromValue(
						utsBBSVlanVPNPRISourceVList, mbean
								.getUtsBBSVlanVPNPRISource()));
		tfUtsBBSMaxFrameSize.setValue(mbean.getUtsBBSMaxFrameSize());
		tfUtsBBSMgmtGratuitousArpLearning.setSelectedIndex(getIndexFromValue(
				vList, mbean.getUtsBBSMgmtGratuitousArpLearning()));
		tfUtsBBSMgmtTrafficTTL.setValue(mbean.getUtsBBSMgmtTrafficTTL());
		tfUtsBBSMgmtArpLearning.setSelectedIndex(getIndexFromValue(vList, mbean
				.getUtsBBSMgmtArpLearning()));
		tfUtsBBSMgmtIgmpProxySourceIP.setValue(mbean
				.getUtsBBSMgmtIgmpProxySourceIP());
//		if (mbean.getUtsBBSMgmtIGMProxySourceInnerVLAN() != null)
//			tfUtsBBSMgmtIGMProxySourceInnerVLAN.setValue(mbean
//					.getUtsBBSMgmtIGMProxySourceInnerVLAN());
//		if (mbean.getUtsBBSMgmtIGMProxySourceOuterVLAN() != null)
//			tfUtsBBSMgmtIGMProxySourceOuterVLAN.setValue(mbean
//					.getUtsBBSMgmtIGMProxySourceOuterVLAN());
		if(mbean.getUtsBbsMacStationMoveSwitch()!=null) {
			tfUtsBbsMacStationMoveSwitch.setSelectedIndex(getIndexFromValue(
				utsBbsMacStationMoveSwitchVList, mbean
						.getUtsBbsMacStationMoveSwitch()));
		}
		else {
			tfUtsBbsMacStationMoveSwitch.setSelectedIndex(-1);
		}
		
		tfUtsBBSDosCtrlIcmpCheck.setSelectedIndex(getIndexFromValue(
				utsBBSDosCtrlIcmpCheckVList,
				mbean.getUtsBBSDosCtrlIcmpCheck() != null ? mbean
						.getUtsBBSDosCtrlIcmpCheck() : 1));
		tfUtsBBS4000R21DosCtrlIcmpPayloadSize.setValue(mbean
				.getUtsBBS4000R21DosCtrlIcmpPayloadSize() != null ? mbean
				.getUtsBBS4000R21DosCtrlIcmpPayloadSize() : 1480);
	}
	...
	public void updateModel() {
		...
		mbean.setUtsBBSBPDUTermination(vList[tfUtsBBSBPDUTermination
				.getSelectedIndex()]);
		mbean
				.setUtsBBSSysSoftwareRateLimiting(vList[tfUtsBBSSysSoftwareRateLimiting
						.getSelectedIndex()]);
		...
		mbean.setUtsBBSVlanVPNTPID(Integer.valueOf(tfUtsBBSVlanVPNTPID
				.getValue(), 16));
		mbean.setUtsBBSMaxFrameSize(tfUtsBBSMaxFrameSize.getValue());
		mbean
				.setUtsBBSMgmtGratuitousArpLearning(vList[tfUtsBBSMgmtGratuitousArpLearning
						.getSelectedIndex()]);
		mbean.setUtsBBSMgmtTrafficTTL(tfUtsBBSMgmtTrafficTTL.getValue());
		mbean.setUtsBBSMgmtArpLearning(vList[tfUtsBBSMgmtArpLearning
				.getSelectedIndex()]);
		mbean.setUtsBBSMgmtIgmpProxySourceIP(tfUtsBBSMgmtIgmpProxySourceIP
				.getIPString());
//		mbean
//				.setUtsBBSMgmtIGMProxySourceInnerVLAN(tfUtsBBSMgmtIGMProxySourceInnerVLAN
//						.getValue());
//		mbean
//				.setUtsBBSMgmtIGMProxySourceOuterVLAN(tfUtsBBSMgmtIGMProxySourceOuterVLAN
//						.getValue());
		if(tfUtsBbsMacStationMoveSwitch.getSelectedIndex()!= -1) {
			mbean
				.setUtsBbsMacStationMoveSwitch(utsBbsMacStationMoveSwitchVList[tfUtsBbsMacStationMoveSwitch
						.getSelectedIndex()]);
		}
		mbean
				.setUtsBBSDosCtrlIcmpCheck(utsBBSDosCtrlIcmpCheckVList[tfUtsBBSDosCtrlIcmpCheck
						.getSelectedIndex()]);
		mbean
				.setUtsBBS4000R21DosCtrlIcmpPayloadSize(tfUtsBBS4000R21DosCtrlIcmpPayloadSize
						.getValue());
	}
