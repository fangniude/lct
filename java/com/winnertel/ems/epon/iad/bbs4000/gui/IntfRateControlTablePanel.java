...
/**
 * The IntfRateControlTablePanel class. Created by DVM Creator
 */
public class IntfRateControlTablePanel extends UPanel
{
	...
	private JComboBox tfUtsIntfRateControlUnicastEnable = new JComboBox(
			utsIntfRateControlUnicastEnableTList);
	...
	private JComboBox tfUtsIntfRateControlIsolationCtrl = new JComboBox(
			utsIntfRateControlIsolationCtrlTList);
  ...
  private String[] utsIntfRateLimitEgressBurstSizeTList = new String[]{
	...
	public void refresh()
	{
		...
		tfUtsIntfRateControlMcastEnable.setSelectedIndex(getIndexFromValue(
				utsIntfRateControlMcastEnableVList, mbean
		...
		tfUtsIntfRateControlBcastEnable.setSelectedIndex(getIndexFromValue(
				utsIntfRateControlBcastEnableVList, mbean
		...
		tfUtsIntfRateControlUnicastEnable.setSelectedIndex(getIndexFromValue(
				utsIntfRateControlUnicastEnableVList, mbean
		...
		tfUtsIntfRateControlIsolationCtrl.setSelectedIndex(getIndexFromValue(
				utsIntfRateControlIsolationCtrlVList, mbean
		...
		tfUtsIntfRateLimitIngressBurstSize.setSelectedIndex(getIndexFromValue(
                utsIntfRateLimitIngressBurstSizeVList,mbean
				.getUtsIntfRateLimitIngressBurstSize().intValue()));
		tfUtsIntfRateLimitEgressBurstSize.setSelectedIndex(getIndexFromValue(
                utsIntfRateLimitEgressBurstSizeVList,mbean
	...
	public void updateModel()
	{
		...
		mbean.setUtsIntfRateControlMcastEnable(new Integer(
						utsIntfRateControlMcastEnableVList[tfUtsIntfRateControlMcastEnable
								.getSelectedIndex()]));
		mbean.setUtsIntfRateControlMcastLimit(new Integer(
				tfUtsIntfRateControlMcastLimit.getValue()));
		mbean.setUtsIntfRateControlBcastEnable(new Integer(
						utsIntfRateControlBcastEnableVList[tfUtsIntfRateControlBcastEnable
								.getSelectedIndex()]));
		mbean.setUtsIntfRateControlBcastLimit(new Integer(
				tfUtsIntfRateControlBcastLimit.getValue()));
		mbean.setUtsIntfRateControlUnicastEnable(new Integer(
						utsIntfRateControlUnicastEnableVList[tfUtsIntfRateControlUnicastEnable
								.getSelectedIndex()]));
		...
		mbean.setUtsIntfRateControlIsolationCtrl(new Integer(
						utsIntfRateControlIsolationCtrlVList[tfUtsIntfRateControlIsolationCtrl.getSelectedIndex()]));
		...
		mbean.setUtsIntfRateControlAutoNegotiation(new Integer(
						utsIntfRateControlAutoNegotiationVList[tfUtsIntfRateControlAutoNegotiation.getSelectedIndex()]));
		mbean.setUtsIntfRateLimitIngressBurstSize(new Integer(
				utsIntfRateLimitIngressBurstSizeVList[tfUtsIntfRateLimitIngressBurstSize.getSelectedIndex()]));
		mbean.setUtsIntfRateLimitEgressBurstSize(new Integer(
				utsIntfRateLimitEgressBurstSizeVList[tfUtsIntfRateLimitEgressBurstSize.getSelectedIndex()]));
	}
