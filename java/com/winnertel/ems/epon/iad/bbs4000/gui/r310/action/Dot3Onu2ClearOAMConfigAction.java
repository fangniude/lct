...
public class Dot3Onu2ClearOAMConfigAction extends SnmpAction {

	public Dot3Onu2ClearOAMConfigAction(IApplication anApplication) {
		super(anApplication);
	}
	...
	public void executeAction(ActionEvent e) throws OperationFailedException,
		...
		fBean.setUtsDot3Onu2ConfigActions(2);
