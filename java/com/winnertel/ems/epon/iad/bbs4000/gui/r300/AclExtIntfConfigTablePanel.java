...
import com.winnertel.ems.epon.iad.bbs4000.mib.BBS4000PortMibBean;
import com.winnertel.ems.epon.iad.bbs4000.mib.LinkAggregation;
import com.winnertel.ems.epon.iad.bbs4000.mib.r300.AclExtIntfConfigTable;
...
public class AclExtIntfConfigTablePanel extends UPanel {
    ...
    private final String utsAclExtIntfConfigIntfNum = fStringMap.getString("utsAclExtIntfConfigIntfNum") + ": ";
    private final String utsAclExtIntfConfigApplProfileId = fStringMap.getString("utsAclExtIntfConfigApplProfileId") + ": ";
    ...
    public void initGui() {
        ...
        cbUtsAclExtIntfConfigApplProfileId.setName(fStringMap.getString("utsAclExtIntfConfigApplProfileId"));
    ...
    void getAllInterface() {
        ...
        BBS4000PortMibBean protBean = new BBS4000PortMibBean(fApplication.getSnmpProxy());
        Vector v = BeanService.refreshTableBean(fApplication, protBean);

        for (int i = 0; i < v.size(); i++) {
            int index = ((BBS4000PortMibBean) v.get(i)).getUtsSwitchPortExtIfNum();
            result.add(SwitchInterfaceIndexFormatter.format(index));
        }

        //remove the port in lg from port list.
        ...
        //remove the port which is configured with acl alreadly from port list.
