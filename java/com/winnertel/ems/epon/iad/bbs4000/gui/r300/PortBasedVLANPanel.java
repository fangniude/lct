...
public class PortBasedVLANPanel extends UPanel {
    ...
    private int[] utsLagExtDot1qVlanArpProxySwitchVList = new int[]{1, 2,};
    ...
    public void refresh() {
        try {
            ...
            if (SnmpAction.IType.ADD.equals(fCommand)) {
                ...
                tfUtsLagExtDot1qVlanArpProxySwitch.setSelectedIndex(1);
            ...
            tfUtsLagExtDot1qVlanArpProxySwitch.setSelectedIndex(getIndexFromValue(utsLagExtDot1qVlanArpProxySwitchVList, mbean.getUtsLagExtDot1qVlanArpProxySwitch()));
    ...
    public boolean validateFrom() {
        //remarked by Zhou Chao, 2010/1/26 -- for NMS00068680
//        if (SnmpAction.IType.ADD.equals(fCommand)) {
