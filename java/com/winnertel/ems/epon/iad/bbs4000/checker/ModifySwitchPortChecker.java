 ...
 */
public class ModifySwitchPortChecker extends BaseChecker  {
    public ModifySwitchPortChecker(IApplication app) {
        super(app);
    }

    public boolean doCheck(SnmpMibBean[] data, SnmpMibBean[] selectedMibBeans) {
        String error = "";
        String port = MibBeanUtil.getSimpleProperty(selectedMibBeans[0], "utsSwitchPortExtModuleId") + "/" + MibBeanUtil.getSimpleProperty(selectedMibBeans[0], "utsSwitchPortExtPortId");
