...
public class UpgradeBoardChecker extends BaseChecker {

	private IApplication fApplication;
	public UpgradeBoardChecker(IApplication app) {
		super(app);
		fApplication = app;
	}
	...
	public boolean doCheck(SnmpMibBean[] data, SnmpMibBean[] selectedMibBeans) {
        ...
        {
            String msg = fApplication.getActiveDeviceManager().getGuiComposer().getString("Err_Upgrade_Not_CSM");
