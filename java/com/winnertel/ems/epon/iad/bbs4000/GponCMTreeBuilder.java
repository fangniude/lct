...
public class GponCMTreeBuilder extends BaseNodeDecorator {

    public static final String CM_BBS4000_NODE = "FBW5000";

    private IDeviceManager fDeviceManager = null;

    public GponCMTreeBuilder(IApplication anApplication) {
        super(anApplication);
    }
    ...
    private void buildTree(FunctionTreeNode aNode) {
        try {
            URL url = getClass().getClassLoader().getResource("com/winnertel/ems/epon/iad/bbs4000/GponCMTreeNode.xml");
            if (url != null) {
