...
public class CMTreeBuilder extends BaseNodeDecorator {

    public static final String CM_BBS4000_NODE = "FBW5000";

    private IDeviceManager fDeviceManager = null;

    public CMTreeBuilder(IApplication anApplication) {
        super(anApplication);
    }
    ...
    private void buildTree(FunctionTreeNode aNode) {
        try {
            URL url = getClass().getClassLoader().getResource("com/winnertel/ems/epon/iad/bbs4000/CMTreeNode.xml");
            if (url != null) {
