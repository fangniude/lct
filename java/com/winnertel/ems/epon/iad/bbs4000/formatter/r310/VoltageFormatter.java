...
/**
 * This file is used for Voltage Option which unit is 100 uV. 
 * @author hz03696
 *
 */
public class VoltageFormatter extends SnmpFieldFormatter {

    public VoltageFormatter(IApplication anApplication) {
        super(anApplication);
    }
