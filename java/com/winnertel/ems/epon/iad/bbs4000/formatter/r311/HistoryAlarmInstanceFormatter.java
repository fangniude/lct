...
public class HistoryAlarmInstanceFormatter extends SnmpFieldFormatter {

    public HistoryAlarmInstanceFormatter(IApplication anApplication) {
        super(anApplication);
    }

    public Object format(SnmpMibBean aMibBean, String aProperty) throws Exception {
        Integer entityType = (Integer) MibBeanUtil.getSimpleProperty(aMibBean, "utsBbsAlarmHistoryEntityType");
