...
/**
 * This file is used for the temperature option which unit is 1/256 degree.
 * @author hz03696
 *
 */
public class TemperatureFormatter extends SnmpFieldFormatter {

    public TemperatureFormatter(IApplication anApplication) {
        super(anApplication);
    }
