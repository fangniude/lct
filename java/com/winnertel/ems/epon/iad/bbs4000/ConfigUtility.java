...
public class ConfigUtility {
  ...
  public static String OctetToMacAddress(byte[] value) {
    ...
    public static String OctetToMacAddress(char[] value) {
          StringBuffer sb = new StringBuffer();
          for (int i = 0; i < value.length; i++) {
              int b = value[i] & 0xff;
              if (b >= 0 && b < 16) {
              ...
              sb.append(Integer.toHexString(b).toLowerCase());
    ...
    public static String formatIfIndex(String s) {
      return formatIfIndex(Integer.parseInt(s));
    }
  
    public static String formatIfIndex(Integer i) {
...
public static String byteArrayToContractionString(byte[] b) {
    ...
    for(int i = 0; i < b.length; i++)
    {
      for(int j = 0; j < 8; j++)
      {
        ...
        {
          //0-5 byte denotes if the port is included.
          if(i < 6)
          {
          ...
          else if(i < 10) //6-9 byte denotes if the link-aggregation is included.
          {
            int lg = (i-6)*8 + j + 1;
            groupVector.add("" + lg);
          }
      ...
      {
    	  result.append( "lg" );
    	  result.append( groupVector.get( i ) ).append( " " );
      }     
    ...
    if(array != null)
    {
      for(int i = 0; i < array.length; i++)
      {
        ...
        else if(array[i].startsWith("lg"))
        {
          ...
          int pointer = 6 + (lg-1) / 8;
          int mask = b[pointer] + (int)Math.pow(2, (lg-1) % 8);
          b[pointer] = (byte)mask;
        }
        else
        {
  ...
  public static byte[] VlanArrayToVlanMapping(int[] vlan)
  {
    byte[] b = new byte[512];
    ...
    if(vlan != null)
    {
      for(int i = 0; i < vlan.length; i++)
      {
        int offset = (vlan[i] - 1) / 8;
        int mask = (int)Math.pow(2, (vlan[i]-1)%8);
  ...
  public static byte[] VlanArrayToVlanMapping(String[] vlan)
  {
    byte[] b = new byte[512];
  ...
  public static String VlanMappingToVlanString(byte[] b)
  {
    StringBuffer sb = new StringBuffer();
  ...
  public static byte[] VlanStringToVlanMapping(String vlan)
  {
    byte[] b = new byte[512];
    ...
    if(vlan != null)
    {
      ...
      {
        int vlanId = Integer.parseInt(split[i]);
