...
//        initProperty(utsDot3OltPortCurrentTemperature, new SnmpMibBeanProperty(utsDot3OltPortCurrentTemperature, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.2.1.32", ISnmpConstant.INTEGER));
        ...
        initProperty(utsDot3OltPortONUAuthMode, new SnmpMibBeanProperty(utsDot3OltPortONUAuthMode, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.2.1.41", ISnmpConstant.INTEGER));
    }
   ...
   /* public Integer getUtsDot3OltPortTransmissionPower() {
    ...
    public boolean retrieve() throws MibBeanException {
        prepareRead(getProperty(utsDot3OltOperStatus));
        prepareRead(getProperty(utsDot3OltAdminStatus));
        prepareRead(getProperty(utsDot3OltRegisteredONUCount));
        ...
        prepareRead(getProperty(utsDot3OltRxFECEnable));
...
//        prepareRead(getProperty(utsDot3OltPortCurrentTemperature));
        ...
        prepareRead(getProperty(utsDot3OltPortONUAuthMode));
