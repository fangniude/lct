...
//    initProperty(utsDot3Onu2CtcEncryptTraffic, new SnmpMibBeanProperty(utsDot3Onu2CtcEncryptTraffic, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.34", ISnmpConstant.INTEGER));
  ...
  public String getCtcServiceSupported() {
	  ...
	  if ( getUtsDot3Onu2CtcFEPortNumber().intValue() > 0 ) {
		  tmpList.add("FE");
	  }
	  if ( getUtsDot3Onu2CtcGEPortNumber().intValue() > 0 ) {
		  tmpList.add("GE");
	  }
	  if ( getUtsDot3Onu2CtcPOTSPortNumber().intValue() > 0 ) {
		  tmpList.add("VoIP");
	  }
	  if ( getUtsDot3Onu2CtcE1PortNumber().intValue() > 0 ) {
		  tmpList.add("E1");
	  }
...
//    prepareRead(super.getProperty(utsDot3Onu2CtcOui));
    ...
    prepareRead(super.getProperty(utsDot3Onu2CtcGEPortNumber));
    prepareRead(super.getProperty(utsDot3Onu2CtcGEPortList));
    prepareRead(super.getProperty(utsDot3Onu2CtcFEPortNumber));
    prepareRead(super.getProperty(utsDot3Onu2CtcFEPortList));
    prepareRead(super.getProperty(utsDot3Onu2CtcPOTSPortNumber));
    prepareRead(super.getProperty(utsDot3Onu2CtcPOTSPortList));
    prepareRead(super.getProperty(utsDot3Onu2CtcE1PortNumber));
    prepareRead(super.getProperty(utsDot3Onu2CtcE1PortList));
...
//    prepareRead(super.getProperty(utsDot3Onu2CtcMaxDownsQueueNum));
    prepareRead(super.getProperty(utsDot3Onu2CtcBatteryInstalled));
//    prepareRead(super.getProperty(utsDot3Onu2CtcFECAbility));
//    prepareRead(super.getProperty(utsDot3Onu2CtcFECMode));
...
//    prepareRead(super.getProperty(utsDot3Onu2CtcEncryptTraffic));
    prepareRead(super.getProperty(utsDot3Onu2CtcFDBAgingTime));
    prepareRead(super.getProperty(utsDot3Onu2CtcAdmin));
    prepareRead(super.getProperty(utsDot3Onu2CtcRTT));
...
//    prepareSave(getProperty(utsDot3Onu2CtcEncryptTraffic));
  ...
  public SnmpMibBean encode(Properties property)
  {
    ...
    one.setUtsDot3Onu2CtcDeviceId(new Integer(1));
  ...
  public String toString() {
	return new StringBuffer().append( getUtsDot3Onu2CtcModuleId() ).append("-").
					append( getUtsDot3Onu2CtcDeviceId() ).append("-").
					append( getUtsDot3Onu2CtcPortId() ).append("-").
					append( getUtsDot3Onu2CtcLogicalPortId()).toString(); 
  }
}
