...
public class EponMulticastCtrlGroup  extends SnmpMibBean
{
  ...
  public static final String utsOltAcrossVlanMulticastForward = "utsOltAcrossVlanMulticastForward";
  ...
  protected void init()
  {
    ...
    initProperty( utsOltNoCdrForShortJoinLeave,
        new SnmpMibBeanProperty(utsOltNoCdrForShortJoinLeave, ".1.3.6.1.4.1.41355.1800.2.4.3.1.3.1.3", ISnmpConstant.INTEGER));
    initProperty( utsOltNoTimeForShortPreview,
        new SnmpMibBeanProperty(utsOltNoTimeForShortPreview, ".1.3.6.1.4.1.41355.1800.2.4.3.1.3.1.4", ISnmpConstant.INTEGER));
    initProperty( utsOltAcrossVlanMulticastForward,
            new SnmpMibBeanProperty(utsOltAcrossVlanMulticastForward, ".1.3.6.1.4.1.41355.1800.2.4.3.1.3.1.11", ISnmpConstant.INTEGER));
  ...
  public Integer getUtsOltAcrossVlanMulticastForward() {
      return (Integer)getProperty(utsOltAcrossVlanMulticastForward).getValue();
    }

    public void setUtsOltAcrossVlanMulticastForward(Integer aUtsOltAcrossVlanMulticastForward) {
      getProperty(utsOltAcrossVlanMulticastForward).setValue(aUtsOltAcrossVlanMulticastForward);
    }
...
//    getProperty(utsEponMulticastCtrlSuperVidList).setValue( generateBitMap(aUtsEponMulticastCtrlSuperVidList));
  ...
  public boolean retrieve() throws MibBeanException
  {
    ...
    prepareRead(getProperty(utsOltAcrossVlanMulticastForward));
  ...
  public boolean modify() throws MibBeanException
  {
    ...
    prepareSave(getProperty(utsOltAcrossVlanMulticastForward));
