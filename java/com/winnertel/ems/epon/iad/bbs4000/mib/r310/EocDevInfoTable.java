...
public class EocDevInfoTable extends SnmpMibBean {
	...
	public static final String eocDeviceSnmpVersion = "eocDeviceSnmpVersion";
    ...
    protected void init() {
		initProperty(eocDeviceIndex, new SnmpMibBeanProperty(eocDeviceIndex, ".1.3.6.1.4.1.17409.2.3.11.1.1.1", ISnmpConstant.GAUGE));
		initProperty(eocCardIndex, new SnmpMibBeanProperty(eocCardIndex, ".1.3.6.1.4.1.17409.2.3.11.1.1.2", ISnmpConstant.GAUGE));
		...
		initProperty(eocDeviceIpAddress, new SnmpMibBeanProperty(eocDeviceIpAddress, ".1.3.6.1.4.1.17409.2.3.11.1.1.10", ISnmpConstant.IP_ADDRESS));
		...
		initProperty(eocDeviceSnmpVersion, new SnmpMibBeanProperty(eocDeviceSnmpVersion, ".1.3.6.1.4.1.17409.2.3.11.1.1.13", ISnmpConstant.STRING));
    }
	...
	public String getEocDeviceSnmpVersion() {
		return (String) getProperty(eocDeviceSnmpVersion).getValue();
	}

	public void setEocDeviceSnmpVersion(String aEocDeviceSnmpVersion) {
		getProperty(eocDeviceSnmpVersion).setValue(aEocDeviceSnmpVersion);
	}
...
//		prepareRead(getProperty(eocDeviceSnmpVersion));
