...
public class AclExtProfileTable extends SnmpMibBean {
  ...
  protected void init() {
    initProperty(utsAclExtProfileId, new SnmpMibBeanProperty(utsAclExtProfileId, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.1", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldId, new SnmpMibBeanProperty(utsAclExtProfileFieldId, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.2", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleId, new SnmpMibBeanProperty(utsAclExtProfileRuleId, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.3", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileName, new SnmpMibBeanProperty(utsAclExtProfileName, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.4", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileFieldName, new SnmpMibBeanProperty(utsAclExtProfileFieldName, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.5", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileRuleName, new SnmpMibBeanProperty(utsAclExtProfileRuleName, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.6", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileFieldBitmap, new SnmpMibBeanProperty(utsAclExtProfileFieldBitmap, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.7", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskDstMac, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskDstMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.8", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileFieldMaskSrcMac, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskSrcMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.9", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileFieldMaskArpTargetMac, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskArpTargetMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.10", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileFieldMaskArpSendMac, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskArpSendMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.11", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileFieldMaskSrcIp, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskSrcIp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.12", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileFieldMaskDstIp, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskDstIp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.13", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileFieldMaskVlan, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskVlan, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.14", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskEtherType, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskEtherType, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.15", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskTcpSrcPort, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskTcpSrcPort, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.16", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskTcpDstPort, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskTcpDstPort, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.17", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskSrcPortMin, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskSrcPortMin, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.18", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskSrcPortMax, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskSrcPortMax, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.19", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskDstPortMin, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskDstPortMin, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.20", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskDstPortMax, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskDstPortMax, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.21", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskTagPri, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskTagPri, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.22", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskDscp, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskDscp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.23", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskProtocol, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskProtocol, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.24", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskIHL, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskIHL, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.25", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskFragmentOffset, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskFragmentOffset, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.26", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValDstMac, new SnmpMibBeanProperty(utsAclExtProfileRuleValDstMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.100", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileRuleValSrcMac, new SnmpMibBeanProperty(utsAclExtProfileRuleValSrcMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.101", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileRuleValArpTargetMac, new SnmpMibBeanProperty(utsAclExtProfileRuleValArpTargetMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.102", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileRuleValArpSendMac, new SnmpMibBeanProperty(utsAclExtProfileRuleValArpSendMac, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.103", ISnmpConstant.MAC_ADDRESS));
    initProperty(utsAclExtProfileRuleValSrcIp, new SnmpMibBeanProperty(utsAclExtProfileRuleValSrcIp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.104", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileRuleValDstIp, new SnmpMibBeanProperty(utsAclExtProfileRuleValDstIp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.105", ISnmpConstant.STRING));
    initProperty(utsAclExtProfileRuleValVlan, new SnmpMibBeanProperty(utsAclExtProfileRuleValVlan, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.106", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValEtherType, new SnmpMibBeanProperty(utsAclExtProfileRuleValEtherType, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.107", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValTcpSrcPort, new SnmpMibBeanProperty(utsAclExtProfileRuleValTcpSrcPort, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.108", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValTcpDstPort, new SnmpMibBeanProperty(utsAclExtProfileRuleValTcpDstPort, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.109", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValSrcPortMin, new SnmpMibBeanProperty(utsAclExtProfileRuleValSrcPortMin, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.110", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValSrcPortMax, new SnmpMibBeanProperty(utsAclExtProfileRuleValSrcPortMax, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.111", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValDstPortMin, new SnmpMibBeanProperty(utsAclExtProfileRuleValDstPortMin, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.112", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValDstPortMax, new SnmpMibBeanProperty(utsAclExtProfileRuleValDstPortMax, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.113", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValTagPri, new SnmpMibBeanProperty(utsAclExtProfileRuleValTagPri, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.114", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValDscp, new SnmpMibBeanProperty(utsAclExtProfileRuleValDscp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.115", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValProtocol, new SnmpMibBeanProperty(utsAclExtProfileRuleValProtocol, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.116", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewDscp, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewDscp, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.117", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewTagPri, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewTagPri, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.118", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewBandwidth, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewBandwidth, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.119", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewBurstSize, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewBurstSize, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.120", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewOutPort, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewOutPort, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.121", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewOutTag, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewOutTag, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.122", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValNewVlanId, new SnmpMibBeanProperty(utsAclExtProfileRuleValNewVlanId, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.123", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValIHL, new SnmpMibBeanProperty(utsAclExtProfileRuleValIHL, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.124", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValFragmentOffset, new SnmpMibBeanProperty(utsAclExtProfileRuleValFragmentOffset, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.125", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValAction, new SnmpMibBeanProperty(utsAclExtProfileRuleValAction, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.200", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskInVlan, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskInVlan, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.202", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileFieldMaskInTagPri, new SnmpMibBeanProperty(utsAclExtProfileFieldMaskInTagPri, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.203", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValInVlan, new SnmpMibBeanProperty(utsAclExtProfileRuleValInVlan, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.204", ISnmpConstant.INTEGER));
    initProperty(utsAclExtProfileRuleValInTagPri, new SnmpMibBeanProperty(utsAclExtProfileRuleValInTagPri, ".1.3.6.1.4.1.45121.1800.2.4.2.1.1.205", ISnmpConstant.INTEGER));
