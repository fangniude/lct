...
//public class Dot3Olt2PonProtectionMBean extends PONProtectionMBean {
public class Dot3Olt2PonProtectionMBean extends SnmpMibBean {
...
//    public static final String utsPonTrunckProtectionRowStatus = "utsPonTrunckProtectionRowStatus";
    ...
    public Dot3Olt2PonProtectionMBean(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    protected void init() {
        ...
        initProperty(ROW_STATUS, new SnmpMibBeanProperty(ROW_STATUS, ".1.3.6.1.4.1.45121.1800.2.3.1.1.3.12.1.15", ISnmpConstant.INTEGER));
    }
	...
	public Integer getUtsPonTrunckProtectionPort1PortId() {
    	return (Integer) getProperty(utsPonTrunckProtectionPort1PortId).getValue();
    }

    public void setUtsPonTrunckProtectionPort1PortId(Integer aUtsPonTrunckProtectionPort1PortId) {
    	getProperty(utsPonTrunckProtectionPort1PortId).setValue(aUtsPonTrunckProtectionPort1PortId);
    }

    public String getUtsPonTrunckProtectionPort1Interface() {
    	return getUtsPonTrunckProtectionPort1ModuleId() + "/" + getUtsPonTrunckProtectionPort1PortId();
    }
    
    public void setUtsPonTrunckProtectionPort1Interface(String aUtsPonTrunckProtectionPort1Interface) {
        if(aUtsPonTrunckProtectionPort1Interface != null) {
            String[] split = aUtsPonTrunckProtectionPort1Interface.split("/");

            setUtsPonTrunckProtectionPort1ModuleId(Integer.parseInt(split[0]));
            setUtsPonTrunckProtectionPort1DeviceId(1);
            setUtsPonTrunckProtectionPort1PortId(Integer.parseInt(split[1]));
        }
    }
    ...
    public Integer getUtsPonTrunckProtectionPort2PortId() {
    	return (Integer) getProperty(utsPonTrunckProtectionPort2PortId).getValue();
    }

    public void setUtsPonTrunckProtectionPort2PortId(Integer aUtsPonTrunckProtectionPort2PortId) {
        getProperty(utsPonTrunckProtectionPort2PortId).setValue(aUtsPonTrunckProtectionPort2PortId);
    }
    
    public String getUtsPonTrunckProtectionPort2Interface() {
    	return getUtsPonTrunckProtectionPort2ModuleId() + "/" + getUtsPonTrunckProtectionPort2PortId();
    }
    
    public void setUtsPonTrunckProtectionPort2Interface(String aUtsPonTrunckProtectionPort2Interface) {
        if(aUtsPonTrunckProtectionPort2Interface != null) {
            String[] split = aUtsPonTrunckProtectionPort2Interface.split("/");

            setUtsPonTrunckProtectionPort2ModuleId(Integer.parseInt(split[0]));
            setUtsPonTrunckProtectionPort2DeviceId(1);
            setUtsPonTrunckProtectionPort2PortId(Integer.parseInt(split[1]));
        }
    }
...
//        prepareRead(getProperty(utsPonTrunckProtectionRowStatus));
    ...
    public boolean open() throws MibBeanException {
    	setUtsPonTrunckProtectionMode(2);
        prepareSave(getProperty(utsPonTrunckProtectionMode));

        return save();
    }
    
    public boolean close() throws MibBeanException {
    	setUtsPonTrunckProtectionMode(0);
        prepareSave(getProperty(utsPonTrunckProtectionMode));
