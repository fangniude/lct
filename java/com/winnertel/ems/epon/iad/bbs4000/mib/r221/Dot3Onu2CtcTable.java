...
public class Dot3Onu2CtcTable extends SnmpMibBean {
    ...
    public static final String utsDot3Onu2CtcLoid = "utsDot3Onu2CtcLoid";
    ...
    protected void init() {
        ...
        initProperty(utsDot3Onu2CtcMulticastSwitch, new SnmpMibBeanProperty(utsDot3Onu2CtcMulticastSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.27", ISnmpConstant.INTEGER));
        ...
        //initProperty(utsDot3Onu2FlexQinQSwitch, new SnmpMibBeanProperty(utsDot3Onu2FlexQinQSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.60", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2SNumberValid, new SnmpMibBeanProperty(utsDot3Onu2SNumberValid, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.61", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2SNumberForService, new SnmpMibBeanProperty(utsDot3Onu2SNumberForService, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.62", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2dot1xUserName, new SnmpMibBeanProperty(utsDot3Onu2dot1xUserName, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.66", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2dot1xPassword, new SnmpMibBeanProperty(utsDot3Onu2dot1xPassword, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.68", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcLoid, new SnmpMibBeanProperty(utsDot3Onu2CtcLoid, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.71", ISnmpConstant.STRING));
        //initProperty(utsDot3Onu2LoidAuthPassword, new SnmpMibBeanProperty(utsDot3Onu2LoidAuthPassword, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.72", ISnmpConstant.STRING));
    ...
    */
    ...
    public Integer getUtsDot3Onu2FlexQinQSwitch() {
        return (Integer) getProperty(utsDot3Onu2FlexQinQSwitch).getValue();
    }

    public void setUtsDot3Onu2FlexQinQSwitch(Integer aUtsDot3Onu2FlexQinQSwitch) {
    ...
    */
    ...
    public String getUtsDot3Onu2CtcLoid() {
        return (String)getProperty(utsDot3Onu2CtcLoid).getValue();
    }

    public void setUtsDot3Onu2CtcLoid(String aUtsDot3Onu2CtcLoid) {
        getProperty(utsDot3Onu2CtcLoid).setValue(aUtsDot3Onu2CtcLoid);
    }
/*
...
//    	try {
//    		Dot3Onu2CtcValidOnuMacTable onuMacTable = new Dot3Onu2CtcValidOnuMacTable(fSnmpProxy);
//    		onuMacTable.setUtsDot3OnuValidOnuMacModuleId(getUtsDot3Onu2CtcModuleId());
//    		onuMacTable.setUtsDot3OnuValidOnuMacDeviceId(getUtsDot3Onu2CtcDeviceId());
//    		onuMacTable.setUtsDot3OnuValidOnuMacPortId(getUtsDot3Onu2CtcPortId());
//    		onuMacTable.setUtsDot3OnuValidOnuMacAppLPortId(getUtsDot3Onu2CtcLogicalPortId());
//			onuMacTable.retrieve();
//			onuLabel = onuMacTable.getUtsDot3OnuDescription();
...
//    	
    ...
    public boolean retrieve() throws MibBeanException {
        ...
        //prepareRead(getProperty(utsDot3Onu2FlexQinQSwitch));
        ...
        prepareRead(getProperty(utsDot3Onu2CtcLoid));
