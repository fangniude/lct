...
public class Onu2CtcCombinedFeaturesH248Cfg extends SnmpMibBean {
    ...
    protected void init() {
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesModuleId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesModuleId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.1", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesDeviceId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesDeviceId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.2", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesPortId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesPortId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.3", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesLogicalPortId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcCombinedFeaturesLogicalPortId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.4", ISnmpConstant.INTEGER));

        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgPort, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgPort, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.161", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgcIp, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgcIp, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.162", ISnmpConstant.IP_ADDRESS));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgpComPort, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248MgpComPort, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.163", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248BackupMgcIp, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248BackupMgcIp, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.164", ISnmpConstant.IP_ADDRESS));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248BackupMgcComPort, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248BackupMgcComPort, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.165", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248ActiveMgc, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248ActiveMgc, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.166", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RegMode, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RegMode, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.167", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248Mid, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248Mid, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.168", ISnmpConstant.STRING));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatMode, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatMode, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.169", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatCycle, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatCycle, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.170", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatCount, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248HeartbeatCount, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.171", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidNum, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidNum, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.201", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidPrefix, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidPrefix, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.202", ISnmpConstant.STRING));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.203", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidMode, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidMode, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.204", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidDigitLength, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidCfgTidDigitLength, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.205", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidInfoFirstTidName, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248RtpTidInfoFirstTidName, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.231", ISnmpConstant.STRING));
        initProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248IadOperationStaus, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesH248Cfg.utsDot3Onu2CtcH248IadOperationStaus, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.331", ISnmpConstant.INTEGER));
    }
