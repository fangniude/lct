...
/**
 * The ONUScheduleUpgradeResultTableMBean class.
 * Created by QuickDVM
 */
public class ONUScheduleUpgradeResultTableMBean extends SnmpMibBean {
    ...
    public ONUScheduleUpgradeResultTableMBean(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    protected void init() {
        ...
        initProperty(utsDot3OnuFWUpgradeResultStartingHour, new SnmpMibBeanProperty(utsDot3OnuFWUpgradeResultStartingHour, ".1.3.6.1.4.1.45121.1800.2.3.1.7.4.1.1.3", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuFWUpgradeResultStartingMinute, new SnmpMibBeanProperty(utsDot3OnuFWUpgradeResultStartingMinute, ".1.3.6.1.4.1.45121.1800.2.3.1.7.4.1.1.4", ISnmpConstant.INTEGER));
    ...
    public Vector retrieveAll() throws MibBeanException {
        ...
        if(v != null)
        {
          ...
          while(i < v.size())
          {
            ONUScheduleUpgradeResultTableMBean bean = (ONUScheduleUpgradeResultTableMBean)v.get(i);
