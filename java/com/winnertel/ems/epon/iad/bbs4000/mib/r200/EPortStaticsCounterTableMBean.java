...
public class EPortStaticsCounterTableMBean extends SnmpMibBean {
  ...
  public static final String utsEthIfPMStatus = "utsEthIfPMStatus";
  ...
  protected void init() {
    ...
    initProperty(utsEthIfPMStatus, new SnmpMibBeanProperty(utsEthIfPMStatus, ".1.3.6.1.4.1.45121.1800.4.1.1.1.1.100", ISnmpConstant.INTEGER));
  ...
  public Integer getUtsEthIfPMStatus() {
    return (Integer) getProperty(utsEthIfPMStatus).getValue();
  }

  public void setUtsEthIfPMStatus(Integer aUtsEthIfPMStatus)
  {
    getProperty(utsEthIfPMStatus).setValue(aUtsEthIfPMStatus);
  }
  ...
  public boolean retrieve() throws MibBeanException {
    ...
    prepareRead(super.getProperty(utsEthIfPMStatus));
    return load();
  }
  ...
  public boolean modify() throws MibBeanException {
      prepareSave(getProperty(utsEthIfPMStatus));
