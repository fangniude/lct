...
public class IgmpCacheTable extends SnmpMibBean
{
    ...
    public static final String utsIgmpCacheSourceAddress = "utsIgmpCacheSourceAddress";
    ...
    public String getUtsIgmpCacheSourceAddress()
    {
        return (String) getIndex(2);
    }

    public void setUtsIgmpCacheSourceAddress(String aUtsIgmpCacheSourceAddress)
    {
        setIndex(2, aUtsIgmpCacheSourceAddress);
    }
...
//                    igmp.setUtsIgmpCacheSourceAddress((String)igmpVector.get(2));
//                    igmp.setUtsIgmpCacheType((Integer) igmpVector.get(3));
//                    igmp.setUtsIgmpCacheLastReporter((String) igmpVector.get(4));
//                    igmp.setUtsIgmpCacheExpiryTime((Long) igmpVector.get(5));
//
//                    v.add(igmp);
//                }
//
