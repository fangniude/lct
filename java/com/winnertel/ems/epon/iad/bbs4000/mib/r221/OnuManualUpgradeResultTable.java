...
public class OnuManualUpgradeResultTable extends SnmpMibBean {
    ...
    public OnuManualUpgradeResultTable(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    public Vector retrieveAll() throws MibBeanException {
        ...
        if(v != null)
        {
          ...
          while(i < v.size())
          {
            OnuManualUpgradeResultTable bean = (OnuManualUpgradeResultTable)v.get(i);
