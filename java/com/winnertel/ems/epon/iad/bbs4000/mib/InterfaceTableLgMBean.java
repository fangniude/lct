...
/**
 * The InterfaceTableMBean class.
 * Created by QuickDVM
 */
public class InterfaceTableLgMBean extends SnmpMibBean {
    ...
    public InterfaceTableLgMBean(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    public Integer getIfLgIndex() {
        return (Integer)getIndex(0);
    }

    public void setIfLgIndex(Integer aIfIndex) {
        setIndex(0, aIfIndex);
    }
    ...
    public Vector retrieveAll() throws MibBeanException {
        ...
        while(i < v.size())
        {
          InterfaceTableLgMBean bean = (InterfaceTableLgMBean)v.get(i);

          //67633152 - lg1; 83886080 - lg32
          if(bean.getIfLgIndex().intValue() < 67633152 || bean.getIfLgIndex().intValue() > 83886080)
          {
            v.remove(i);
          }
          else
