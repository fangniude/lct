...
public class FileInfoMgmtTable extends SnmpMibBean {
    ...
    public FileInfoMgmtTable(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    */
    ...
    public boolean retrieve() throws MibBeanException {
        prepareRead(getProperty(filePath));
        prepareRead(getProperty(fileName));
