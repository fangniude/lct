...
public class GeneralPonTTLConfig extends SnmpMibBean {
    ...
    public static final String utsBBSDosCtrlIcmpCheck = "utsBBSDosCtrlIcmpCheck";
    public static final String utsBBS4000R21DosCtrlIcmpPayloadSize = "utsBBS4000R21DosCtrlIcmpPayloadSize";
    ...
    public static final String utsBbsMacStationMoveSwitch = "utsBbsMacStationMoveSwitch";
    ...
    public Integer getUtsBbsMacStationMoveSwitch() {
        return (Integer) getProperty(utsBbsMacStationMoveSwitch).getValue();
    }

    public void setUtsBbsMacStationMoveSwitch(Integer aUtsBbsMacStationMoveSwitch) {
        getProperty(utsBbsMacStationMoveSwitch).setValue(aUtsBbsMacStationMoveSwitch);
    }
    ...
    public boolean retrieve() throws MibBeanException {
        ...
        prepareRead(getProperty(utsBbsMacStationMoveSwitch));
    ...
    public boolean modify() throws MibBeanException {
        ...
        prepareSave(getProperty(utsBbsMacStationMoveSwitch));
