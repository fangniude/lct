...
public class OnuAclExtProfileTable extends SnmpMibBean {
    ...
    protected void init()
    {
     initProperty( utsOnuAclExtProfileSlotNo, new SnmpMibBeanProperty( utsOnuAclExtProfileSlotNo, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.1", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfilePortNo, new SnmpMibBeanProperty( utsOnuAclExtProfilePortNo, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.2", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileLogicalPortNo, new SnmpMibBeanProperty( utsOnuAclExtProfileLogicalPortNo, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.3", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileOnuUniPortNo, new SnmpMibBeanProperty( utsOnuAclExtProfileOnuUniPortNo, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.4", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileId, new SnmpMibBeanProperty( utsOnuAclExtProfileId, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.5", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldId, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldId, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.6", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleId, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleId, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.7", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileName, new SnmpMibBeanProperty( utsOnuAclExtProfileName, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.11", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldName, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldName, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.12", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleName, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleName, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.13", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldBitmap, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldBitmap, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.14", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskDstMac, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskDstMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.15", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskSrcMac, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskSrcMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.16", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskArpTargetMac, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskArpTargetMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.17", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskArpSendMac, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskArpSendMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.18", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskSrcIp, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskSrcIp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.19", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskDstIp, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskDstIp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.20", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileFieldMaskVlan, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskVlan, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.21", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskEtherType, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskEtherType, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.22", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskTcpSrcPort, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskTcpSrcPort, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.23", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskTcpDstPort, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskTcpDstPort, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.24", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskSrcPortMin, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskSrcPortMin, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.25", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskSrcPortMax, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskSrcPortMax, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.26", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskDstPortMin, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskDstPortMin, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.27", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskDstPortMax, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskDstPortMax, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.28", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskTagPri, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskTagPri, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.29", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskDscp, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskDscp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.30", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskProtocol, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskProtocol, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.31", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskIHL, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskIHL, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.32", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileFieldMaskFragmentOffset, new SnmpMibBeanProperty( utsOnuAclExtProfileFieldMaskFragmentOffset, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.33", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValDstMac, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValDstMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.100", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValSrcMac, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValSrcMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.101", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValArpTargetMac, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValArpTargetMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.102", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValArpSendMac, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValArpSendMac, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.103", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValSrcIp, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValSrcIp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.104", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValDstIp, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValDstIp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.105", ISnmpConstant.STRING));
     initProperty( utsOnuAclExtProfileRuleValVlan, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValVlan, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.106", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValEtherType, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValEtherType, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.107", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValTcpSrcPort, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValTcpSrcPort, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.108", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValTcpDstPort, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValTcpDstPort, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.109", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValSrcPortMin, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValSrcPortMin, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.110", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValSrcPortMax, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValSrcPortMax, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.111", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValDstPortMin, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValDstPortMin, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.112", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValDstPortMax, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValDstPortMax, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.113", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValTagPri, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValTagPri, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.114", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValDscp, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValDscp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.115", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValProtocol, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValProtocol, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.116", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewDscp, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewDscp, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.117", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewTagPri, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewTagPri, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.118", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewBandwidth, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewBandwidth, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.119", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewBurstSize, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewBurstSize, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.120", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewOutPort, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewOutPort, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.121", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewOutTag, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewOutTag, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.122", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValNewVlanId, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValNewVlanId, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.123", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValIHL, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValIHL, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.124", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValFragmentOffset, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValFragmentOffset, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.125", ISnmpConstant.INTEGER));
     initProperty( utsOnuAclExtProfileRuleValAction, new SnmpMibBeanProperty( utsOnuAclExtProfileRuleValAction, ".1.3.6.1.4.1.41355.1.3.10.5.1000.6.1.200", ISnmpConstant.INTEGER));
