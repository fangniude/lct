...
public class GeneralPonTTLConfig extends SnmpMibBean {
    ...
    protected void init() {
        ...
        //initProperty(utsPortsEgressOuterTpid, new SnmpMibBeanProperty(utsPortsEgressOuterTpid, ".1.3.6.1.4.1.41355.1.3.10.16.2.2.1", ISnmpConstant.INTEGER));
        ...
        initProperty(utsBBSMgmtIGMPVersion, new SnmpMibBeanProperty(utsBBSMgmtIGMPVersion, ".1.3.6.1.4.1.41355.1800.2.1.1.4.1.60", ISnmpConstant.INTEGER));

        initProperty(utsBBSDosCtrlIcmpCheck, new SnmpMibBeanProperty(utsBBSDosCtrlIcmpCheck, ".1.3.6.1.4.1.41355.1.3.10.200.6.2.1.1.4.1.6.1", ISnmpConstant.INTEGER)); //added by Zhou Chao, 2010/1/26 -- for NMS00068690
        initProperty(utsBBS4000R21DosCtrlIcmpPayloadSize, new SnmpMibBeanProperty(utsBBS4000R21DosCtrlIcmpPayloadSize, ".1.3.6.1.4.1.41355.1.3.10.200.6.2.1.1.4.1.6.2", ISnmpConstant.INTEGER)); //added by Zhou Chao, 2010/1/26 -- for NMS00068690
    }
