...
//  }
  ...
  public Double getUtsDot3OltPortTransmissionPowerDisplay() {
	return new Double(getUtsDot3OltPortTransmissionPower())/1000;
  }
  ...
  public Double getUtsDot3OltPortReceivingPowerDisplay() {
	return new Double(getUtsDot3OltPortReceivingPower())/1000;
  }
  ...
  public Double getUtsDot3OltPortSupplyVoltageDisplay() {
	return new Double(getUtsDot3OltPortSupplyVoltage())/1000;
  }
  ...
  public Double getUtsDot3OltPortCurrentBiasDisplay() {
	return new Double(getUtsDot3OltPortCurrentBias())/1000;
  }
  ...
  public Double getUtsDot3OltPortCurrentTemperatureDisplay() {
	return new Double(getUtsDot3OltPortCurrentTemperature())/1000;
  }
  ...
  public Integer getUtsDot3OltPortONUSNumberSwitch() {
	...
	public void setUtsDot3OltPortONUSNumberSwitch(
			Integer aUtsDot3OltPortONUSNumberSwitch) {
		getProperty(utsDot3OltPortONUSNumberSwitch).setValue(
				aUtsDot3OltPortONUSNumberSwitch);
	}
