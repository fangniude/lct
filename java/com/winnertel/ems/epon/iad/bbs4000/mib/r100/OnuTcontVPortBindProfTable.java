...
public class OnuTcontVPortBindProfTable extends SnmpMibBean {
    ...
    protected void init() {
        initProperty(tcontVirtualPortBindingProfileIndex, new SnmpMibBeanProperty(tcontVirtualPortBindingProfileIndex, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.1", ISnmpConstant.GAUGE));
        //initProperty(tcontVirtualPortBindingProfileVirtualPortNo, new SnmpMibBeanProperty(tcontVirtualPortBindingProfileVirtualPortNo, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.2", ISnmpConstant.INTEGER));
        initProperty(onuTcontVPortBindProfileName, new SnmpMibBeanProperty(onuTcontVPortBindProfileName, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.3", ISnmpConstant.STRING));
        initProperty(virtualPortServicePr, new SnmpMibBeanProperty(virtualPortServicePr, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.4", ISnmpConstant.GAUGE));
        initProperty(tcontIndex, new SnmpMibBeanProperty(tcontIndex, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.5", ISnmpConstant.GAUGE));
        initProperty(tcontServiceProfileIndex, new SnmpMibBeanProperty(tcontServiceProfileIndex, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.6", ISnmpConstant.GAUGE));

        initProperty(ROW_STATUS, new SnmpMibBeanProperty(ROW_STATUS, ".1.3.6.1.4.1.41355.1.3.10.5.2.1.1.7", ISnmpConstant.INTEGER));
    }
