...
//        }
    ...
    public String toString() {
        return new StringBuffer().append(getUtsDot3OnuValidOnuMacModuleId()).append("-").append(getUtsDot3OnuValidOnuMacPortId()).append("-").append(getUtsDot3OnuValidOnuMacAppLPortId()).toString();
    }
