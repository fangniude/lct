...
/**
 * The DHCPPoolDefaultRouterTable class. Created by QuickDVM
 */
public class DHCPPoolDefaultRouterTable extends SnmpMibBean
{
	public static final String utsDHCPPoolName = "utsDHCPPoolName";

	public static final String utsDHCPPoolDefaultRouterIpAddress = "utsDHCPPoolDefaultRouterIpAddress";

	public DHCPPoolDefaultRouterTable(ISnmpProxy aSnmpProxy)
	{
		super(aSnmpProxy);
		init();
	}
	...
	public String getUtsDHCPPoolDefaultRouterIpAddress()
	{
	...
	public void setUtsDHCPPoolDefaultRouterIpAddress(
			String aUtsDHCPPoolDefaultRouterIpAddress)
	{
		setIndex(1, aUtsDHCPPoolDefaultRouterIpAddress);
	}
	...
	{
		prepareRead(getProperty(utsDHCPPoolDefaultRouterIpAddress));
	...
	public boolean modify() throws MibBeanException
	{
		...
		prepareSave(getProperty(utsDHCPPoolDefaultRouterIpAddress));
