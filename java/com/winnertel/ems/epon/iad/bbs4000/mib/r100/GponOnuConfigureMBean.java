...
public class GponOnuConfigureMBean extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(onuCfgServiceSubscription, new SnmpMibBeanProperty(onuCfgServiceSubscription, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.10", ISnmpConstant.INTEGER));
        initProperty(onuCfgOnuEqualizationDelay, new SnmpMibBeanProperty(onuCfgOnuEqualizationDelay, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.11", ISnmpConstant.INTEGER));
        ...
        initProperty(onuCfgOnuHardwareType, new SnmpMibBeanProperty(onuCfgOnuHardwareType, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.23", ISnmpConstant.INTEGER));
        initProperty(onuCfgOnuHardwareRevision, new SnmpMibBeanProperty(onuCfgOnuHardwareRevision, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.24", ISnmpConstant.INTEGER));
        ...
        initProperty(onuCfgSysUpTime, new SnmpMibBeanProperty(onuCfgSysUpTime, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.33", ISnmpConstant.INTEGER));
        initProperty(onuCfgOnuImageInstance0Version, new SnmpMibBeanProperty(onuCfgOnuImageInstance0Version, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.34", ISnmpConstant.GAUGE));
        ...
        initProperty(onuCfgOnuImageInstance1Version, new SnmpMibBeanProperty(onuCfgOnuImageInstance1Version, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.38", ISnmpConstant.GAUGE));
        ...
        //initProperty(onuCfgOnuMulticastGemPortNo, new SnmpMibBeanProperty(onuCfgOnuMulticastGemPortNo, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.49", ISnmpConstant.INTEGER));
        ...
        initProperty(onuCfgMacLimit, new SnmpMibBeanProperty(onuCfgMacLimit, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.48", ISnmpConstant.INTEGER));
        ...
        initProperty(onuCfgOnuFastLeaveCapability, new SnmpMibBeanProperty(onuCfgOnuFastLeaveCapability, ".1.3.6.1.4.1.45121.1.3.10.5.1.5.1.50", ISnmpConstant.INTEGER));
