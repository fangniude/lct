...
public class IntfRateControlGEMTable extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsIntfRateControlUplinkDuplexStatus, new SnmpMibBeanProperty(utsIntfRateControlUplinkDuplexStatus, ".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.19", ISnmpConstant.INTEGER));
        initProperty(utsIntfRateControlUplinkPortMode, new SnmpMibBeanProperty(utsIntfRateControlUplinkPortMode, ".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.20", ISnmpConstant.INTEGER));
    }
    ...
    public boolean retrieve() throws MibBeanException {
        ...
        prepareRead(super.getProperty(utsIntfRateControlUplinkDuplexStatus));
        prepareRead(super.getProperty(utsIntfRateControlUplinkPortMode));
