...
public class AclExtIntfConfigTable extends SnmpMibBean
{
  ...
  public boolean retrieve() throws MibBeanException
    ...
    prepareRead(super.getProperty(utsAclExtIntfConfigFlowDirection));
