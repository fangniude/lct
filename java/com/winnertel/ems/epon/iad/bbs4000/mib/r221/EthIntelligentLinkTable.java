...
public class EthIntelligentLinkTable extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsEthIntelligentLinkAutoReturn, new SnmpMibBeanProperty(utsEthIntelligentLinkAutoReturn, ".1.3.6.1.4.1.45121.1800.2.2.1.15.1.16", ISnmpConstant.INTEGER));
        initProperty(utsEthIntelligentLinkAutoWtr, new SnmpMibBeanProperty(utsEthIntelligentLinkAutoWtr, ".1.3.6.1.4.1.45121.1800.2.2.1.15.1.17", ISnmpConstant.INTEGER));
        initProperty(utsEthIntelligentLinkReturnToMaster, new SnmpMibBeanProperty(utsEthIntelligentLinkReturnToMaster, ".1.3.6.1.4.1.45121.1800.2.2.1.15.1.18", ISnmpConstant.INTEGER));
    }
