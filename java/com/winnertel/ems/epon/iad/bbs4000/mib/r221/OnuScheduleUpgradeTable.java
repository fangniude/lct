...
public class OnuScheduleUpgradeTable extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsDot3OnuFWUpgradeActCommitFlag, new SnmpMibBeanProperty(utsDot3OnuFWUpgradeActCommitFlag, ".1.3.6.1.4.1.45121.1800.2.3.1.7.3.1.1.8", ISnmpConstant.INTEGER));
    }
