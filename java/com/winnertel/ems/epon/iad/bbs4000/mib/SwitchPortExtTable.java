...
public class SwitchPortExtTable extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsSwitchPortExtACLDefAction, new SnmpMibBeanProperty(utsSwitchPortExtACLDefAction, ".1.3.6.1.4.1.41355.1800.2.2.1.8.1.6", ISnmpConstant.INTEGER));
        initProperty(utsSwitchPortExtAdmFlowControlRx, new SnmpMibBeanProperty(utsSwitchPortExtAdmFlowControlRx, ".1.3.6.1.4.1.41355.1800.2.2.1.8.1.7", ISnmpConstant.INTEGER));
        initProperty(utsSwitchPortExtAdmFlowControlTx, new SnmpMibBeanProperty(utsSwitchPortExtAdmFlowControlTx, ".1.3.6.1.4.1.41355.1800.2.2.1.8.1.9", ISnmpConstant.INTEGER));
        initProperty(utsSwitchPortExtIpMuticastFilter, new SnmpMibBeanProperty(utsSwitchPortExtIpMuticastFilter, ".1.3.6.1.4.1.41355.1800.2.2.1.8.1.11", ISnmpConstant.INTEGER));
    }
    ...
    public void setUtsSwitchPortExtACLDefAction(Integer aUtsSwitchPortExtACLDefAction) {
        getProperty(utsSwitchPortExtACLDefAction).setValue(aUtsSwitchPortExtACLDefAction);
    }

    public Integer getUtsSwitchPortExtAdmFlowControlRx() {
        return (Integer) getProperty(utsSwitchPortExtAdmFlowControlRx).getValue();
    }

    public void setUtsSwitchPortExtAdmFlowControlRx(Integer aUtsSwitchPortExtAdmFlowControlRx) {
        getProperty(utsSwitchPortExtAdmFlowControlRx).setValue(aUtsSwitchPortExtAdmFlowControlRx);
    }

    public Integer getUtsSwitchPortExtAdmFlowControlTx() {
        return (Integer) getProperty(utsSwitchPortExtAdmFlowControlTx).getValue();
    }

    public void setUtsSwitchPortExtAdmFlowControlTx(Integer aUtsSwitchPortExtAdmFlowControlTx) {
        getProperty(utsSwitchPortExtAdmFlowControlTx).setValue(aUtsSwitchPortExtAdmFlowControlTx);
    }

    public Integer getUtsSwitchPortExtIpMuticastFilter() {
        return (Integer) getProperty(utsSwitchPortExtIpMuticastFilter).getValue();
    }

    public void setUtsSwitchPortExtIpMuticastFilter(Integer aUtsSwitchPortExtIpMuticastFilter) {
        getProperty(utsSwitchPortExtIpMuticastFilter).setValue(aUtsSwitchPortExtIpMuticastFilter);
    }

    public boolean retrieve() throws MibBeanException {
        prepareRead(getProperty(utsSwitchPortExtModuleId));
        prepareRead(getProperty(utsSwitchPortExtPortId));
        prepareRead(getProperty(utsSwitchPortExtLAGId));
        prepareRead(getProperty(utsSwitchPortExtPortType));
        prepareRead(getProperty(utsSwitchPortExtACLDefAction));
        prepareRead(getProperty(utsSwitchPortExtAdmFlowControlRx));
        prepareRead(getProperty(utsSwitchPortExtAdmFlowControlTx));
        prepareRead(getProperty(utsSwitchPortExtIpMuticastFilter));
    ...
    public Vector retrieveAll() throws MibBeanException {
        ...
        //filter the list.
        if (getIndex(0) != null) {
            int number = Integer.parseInt((String) getIndex(0));
            int i = 0;
            while (i < v.size()) {
                if (((SwitchPortExtTable) v.get(i)).getUtsSwitchPortExtIfNum().intValue() - number > 4) {
                    v.remove(i);
                } else {
                    i++;
                }
        ...
        int i = 0;
        while (i < v.size()) {
            String portName = ((SwitchPortExtTable) v.get(i)).getUtsSwitchPortExtModuleId() + "/" + ((SwitchPortExtTable) v.get(i)).getUtsSwitchPortExtPortId();
