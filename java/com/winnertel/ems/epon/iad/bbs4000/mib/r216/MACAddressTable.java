...
//                Vector tftpVector = mibMgr.retrieveAll(neName, "utsLagExtLinkAggMacTable");
//
//                v = new Vector(tftpVector.size());
//                for (int i = 0; i < tftpVector.size(); i++) {
//                    MACAddressTable mac = new MACAddressTable(fSnmpProxy);
//
//                    Vector macVector = (Vector) tftpVector.get(i);
//
//                    mac.setUtsLagExtLinkAggMacInterface((String) macVector.get(0));
//                    mac.setUtsLagExtLinkAggMacModule((Integer) macVector.get(1));
//                    mac.setUtsLagExtLinkAggMacPort((Integer) macVector.get(2));
//                    mac.setUtsLagExtLinkAggMacVlanId((Integer) macVector.get(3));
//                    mac.setUtsLagExtLinkAggMacIsStatic((Integer) macVector.get(4));
//                    mac.setUtsLagExtLinkAggMacIntfType((Integer) macVector.get(5));
//                    mac.setUtsLagExtLinkAggMacTrunkId((Integer) macVector.get(6));
//                    mac.setUtsLagExtLinkAggMacAddress((byte[]) macVector.get(7));
//
//                    v.add(mac);
//                }
//
