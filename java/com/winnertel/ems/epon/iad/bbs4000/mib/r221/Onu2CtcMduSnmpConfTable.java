...
public class Onu2CtcMduSnmpConfTable extends SnmpMibBean {
    ...
    public Onu2CtcMduSnmpConfTable(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    public boolean retrieve() throws MibBeanException {
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfSnmpVer));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfTrapHost));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfTrapPort));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfSnmpPort));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfSecurityName));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfCommunityRead));
        prepareRead(getProperty(utsDot3Onu2CtcMduSnmpConfCommunityWrite));
...
//                    Onu2CtcMduSnmpConfTable bean = (Onu2CtcMduSnmpConfTable) v.get(i);
