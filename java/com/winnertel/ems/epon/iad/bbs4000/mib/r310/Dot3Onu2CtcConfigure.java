...
public class Dot3Onu2CtcConfigure extends SnmpMibBean {
    ...
    public static final String utsDot3Onu2CtcFECAbility = "utsDot3Onu2CtcFECAbility";  //R3.1.0
    public static final String utsDot3Onu2CtcFECMode = "utsDot3Onu2CtcFECMode"; //R3.1.0
    ...
    public static final String utsDot3Onu2CtcEncryptTraffic = "utsDot3Onu2CtcEncryptTraffic"; //R3.1.0
    ...
    public static final String utsDot3Onu2CtcAdmin = "utsDot3Onu2CtcAdmin";   //R3.1.0
    //public static final String utsDot3Onu2CtcRTT = "utsDot3Onu2CtcRTT";
    public static final String utsDot3Onu2CtcPVid = "utsDot3Onu2CtcPVid";  //R3.1.0
    public static final String utsDot3Onu2CtcMaxMacAddress = "utsDot3Onu2CtcMaxMacAddress";  //R3.1.0
    ...
    public static final String utsDot3Onu2EthernetPortAlarmReversion = "utsDot3Onu2EthernetPortAlarmReversion";  //R3.1.0
    //public static final String utsDot3Onu2MulticastFilter = "utsDot3Onu2MulticastFilter";
    //public static final String utsDot3Onu2FlexQinQSwitch = "utsDot3Onu2FlexQinQSwitch";
    ...
    public static final String utsDot3Onu2dot1xUserName = "utsDot3Onu2dot1xUserName"; //R3.1.0
    public static final String utsDot3Onu2dot1xPassword = "utsDot3Onu2dot1xPassword"; //R3.1.0
    ...
    public static final String utsDot3OnuCatvSwitch = "utsDot3OnuCatvSwitch"; //R3.1.0

    protected int catvSwitchValue = 0;

    private String onuLabel = null; //added by Zhouchao, 2011/8/26

    public Dot3Onu2CtcConfigure(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }
    ...
    protected void init() {
        ...
        //initProperty(utsDot3Onu2CtcFwVer, new SnmpMibBeanProperty(utsDot3Onu2CtcFwVer, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.9", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcChipsetId, new SnmpMibBeanProperty(utsDot3Onu2CtcChipsetId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.10", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcGEPortNumber, new SnmpMibBeanProperty(utsDot3Onu2CtcGEPortNumber, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.11", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcGEPortList, new SnmpMibBeanProperty(utsDot3Onu2CtcGEPortList, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.12", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcFEPortNumber, new SnmpMibBeanProperty(utsDot3Onu2CtcFEPortNumber, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.13", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcFEPortList, new SnmpMibBeanProperty(utsDot3Onu2CtcFEPortList, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.14", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcPOTSPortNumber, new SnmpMibBeanProperty(utsDot3Onu2CtcPOTSPortNumber, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.15", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcPOTSPortList, new SnmpMibBeanProperty(utsDot3Onu2CtcPOTSPortList, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.16", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcE1PortNumber, new SnmpMibBeanProperty(utsDot3Onu2CtcE1PortNumber, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.17", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcE1PortList, new SnmpMibBeanProperty(utsDot3Onu2CtcE1PortList, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.18", ISnmpConstant.OCTETS));
        ...
        //initProperty(utsDot3Onu2CtcBatteryInstalled, new SnmpMibBeanProperty(utsDot3Onu2CtcBatteryInstalled, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.23", ISnmpConstant.INTEGER));
        ...
        //initProperty(utsDot3Onu2CtcClassifiRuleClear, new SnmpMibBeanProperty(utsDot3Onu2CtcClassifiRuleClear, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.26", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuMulticastSwitch, new SnmpMibBeanProperty(utsDot3OnuMulticastSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.27", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcMCastControlType, new SnmpMibBeanProperty(utsDot3Onu2CtcMCastControlType, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.28", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcMCastEntryNum, new SnmpMibBeanProperty(utsDot3Onu2CtcMCastEntryNum, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.29", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcMCastEntryClear, new SnmpMibBeanProperty(utsDot3Onu2CtcMCastEntryClear, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.30", ISnmpConstant.INTEGER));
        ...
        //initProperty(utsDot3Onu2CtcFDBAgingTime, new SnmpMibBeanProperty(utsDot3Onu2CtcFDBAgingTime, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.35", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcFDBClear, new SnmpMibBeanProperty(utsDot3Onu2CtcFDBClear, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.36", ISnmpConstant.INTEGER));
        ...
        //initProperty(utsDot3Onu2CtcRTT, new SnmpMibBeanProperty(utsDot3Onu2CtcRTT, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.38", ISnmpConstant.INTEGER));
        ...
        //initProperty(utsDot3Onu2CtcVoIPPortLock, new SnmpMibBeanProperty(utsDot3Onu2CtcVoIPPortLock, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.50", ISnmpConstant.OCTETS));
        //initProperty(utsDot3Onu2CtcE1PortLock, new SnmpMibBeanProperty(utsDot3Onu2CtcE1PortLock, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.51", ISnmpConstant.OCTETS));
        initProperty(utsDot3Onu2FastLeaveAbility, new SnmpMibBeanProperty(utsDot3Onu2FastLeaveAbility, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.54", ISnmpConstant.OCTETS));
        initProperty(utsDot3Onu2FastLeaveAdminControl, new SnmpMibBeanProperty(utsDot3Onu2FastLeaveAdminControl, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.55", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2EthernetPortAlarmReversion, new SnmpMibBeanProperty(utsDot3Onu2EthernetPortAlarmReversion, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.56", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2MulticastFilter, new SnmpMibBeanProperty(utsDot3Onu2MulticastFilter, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.58", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2FlexQinQSwitch, new SnmpMibBeanProperty(utsDot3Onu2FlexQinQSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.60", ISnmpConstant.INTEGER)); //added by Zhou Chao, 2008/8/4
        ...
        //initProperty(utsDot3Onu2LoidAuthLoid, new SnmpMibBeanProperty(utsDot3Onu2LoidAuthLoid, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.71", ISnmpConstant.STRING)); //added by Zhou Chao, 2010/4/30
        //initProperty(utsDot3Onu2LoidAuthPassword, new SnmpMibBeanProperty(utsDot3Onu2LoidAuthPassword, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.72", ISnmpConstant.STRING)); //added by Zhou Chao, 2010/4/30
        initProperty(utsDot3OnuCatvSwitch, new SnmpMibBeanProperty(utsDot3OnuCatvSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.10.1.101", ISnmpConstant.INTEGER)); //added by Zhou Chao, 2010/4/30
    ...
    */
    ...
    public Integer getUtsDot3OnuMulticastSwitch() {
        return (Integer) getProperty(utsDot3OnuMulticastSwitch).getValue();
    }

    public void setUtsDot3OnuMulticastSwitch(Integer aUtsDot3OnuMulticastSwitch) {
        getProperty(utsDot3OnuMulticastSwitch).setValue(aUtsDot3OnuMulticastSwitch);
    }
...
*/
    ...
    */
    ...
    public Integer getUtsDot3OnuCatvSwitch() {
        catvSwitchValue = (Integer) getProperty(utsDot3OnuCatvSwitch).getValue();
    ...
    public void setUtsDot3OnuCatvSwitch(Integer aUtsDot3OnuCatvSwitch) {
        if (getProperty(utsDot3OnuCatvSwitch).getValue() == null)
            catvSwitchValue = aUtsDot3OnuCatvSwitch;
    ...
    public boolean retrieve() throws MibBeanException {
        ...
        prepareRead(getProperty(utsDot3OnuMulticastSwitch));
...
//                for (int i = 0; i < v.size(); i++) {
//                    Dot3Onu2CtcConfigure bean = (Dot3Onu2CtcConfigure) v.get(i);
...
//        }
    ...
    public boolean modify() throws MibBeanException {
        ...
        prepareSave(getProperty(utsDot3OnuMulticastSwitch));
        ...
        //prepareSave(getProperty(utsDot3Onu2CtcPVid)); ONS00041527	kunming_liang	zbcheng	NMS remove, baoyin MIB modification RO
        ...
        //prepareSave(getProperty(utsDot3Onu2FlexQinQSwitch));
        ...
        if (catvSwitchValue != 0 && catvSwitchValue != (Integer) getProperty(utsDot3OnuCatvSwitch).getValue()) {
    ...
    public SnmpMibBean encode(Properties property) {
        Dot3Onu2CtcConfigure one = (Dot3Onu2CtcConfigure) this.clone();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Dot3Onu2CtcConfigure) {
            Dot3Onu2CtcConfigure bean = (Dot3Onu2CtcConfigure) obj;
            for (int i = 0; i < 4; i++) {
