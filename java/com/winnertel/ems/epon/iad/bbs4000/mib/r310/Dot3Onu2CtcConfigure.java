...
public class Dot3Onu2CtcConfigure extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsDot3OnuMulticastSwitch, new SnmpMibBeanProperty(utsDot3OnuMulticastSwitch, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.10.1.27", ISnmpConstant.INTEGER));
