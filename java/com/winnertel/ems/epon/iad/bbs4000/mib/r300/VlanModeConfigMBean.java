...
public class VlanModeConfigMBean extends SnmpMibBean {
  ...
  protected void init() {
    ...
    initProperty(utsDot3OnuEtherPortVlanNTo1Translation, new SnmpMibBeanProperty(utsDot3OnuEtherPortVlanNTo1Translation, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.50", ISnmpConstant.OCTETS));
  }
