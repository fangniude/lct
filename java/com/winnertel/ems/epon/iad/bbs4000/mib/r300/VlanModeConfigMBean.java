...
public class VlanModeConfigMBean extends SnmpMibBean {
  ...
  public static final String utsDot3OnuEtherPortVlanNTo1Translation = "utsDot3OnuEtherPortVlanNTo1Translation";
  ...
  protected void init() {
    ...
    initProperty(utsDot3OnuEtherPortVlanNTo1Translation, new SnmpMibBeanProperty(utsDot3OnuEtherPortVlanNTo1Translation, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.11.1.50", ISnmpConstant.OCTETS));
  }
  ...
  public byte[] getUtsDot3OnuEtherPortVlanNTo1Translation() {
    return (byte[])getProperty(utsDot3OnuEtherPortVlanNTo1Translation).getValue();
  }

  public void setUtsDot3OnuEtherPortVlanNTo1Translation(byte[] aUtsDot3OnuEtherPortVlanNTo1Translation) {
    getProperty(utsDot3OnuEtherPortVlanNTo1Translation).setValue(aUtsDot3OnuEtherPortVlanNTo1Translation);
  }
  ...
  public boolean retrieve() throws MibBeanException {
    ...
    prepareRead(super.getProperty(utsDot3OnuEtherPortVlanNTo1Translation));
  ...
  public boolean modify() throws MibBeanException {
    prepareSave(getProperty(utsDot3OnuEtherPortVlanNTo1Translation));
