...
//        String instr = (String) getProperty(utsMonitorSessionIngressPortBitLists).getValue();
//        return ConfigUtility.portMappingToContractionString(instr);
    }
...
//        String list = (String)getProperty(utsMonitorSessionEngressPortBitLists).getValue();
//        return ConfigUtility.portMappingToContractionString(list);
    }
