...
public class EponModuleBoardTable extends SnmpMibBean {
  ...
  protected void init() {
    ...
    initProperty(utsEponModuleBoardHwVer, new SnmpMibBeanProperty(utsEponModuleBoardHwVer, ".1.3.6.1.4.1.41355.1.3.10.200.6.2.1.1.1.1.21", ISnmpConstant.OCTETS));
    ...
    initProperty(utsEponModuleBoardCpuUtil, new SnmpMibBeanProperty(utsEponModuleBoardCpuUtil, ".1.3.6.1.4.1.41355.1.3.10.200.6.2.1.1.1.1.27", ISnmpConstant.INTEGER));
    initProperty(utsEponModuleBoardMemUtil, new SnmpMibBeanProperty(utsEponModuleBoardMemUtil, ".1.3.6.1.4.1.41355.1.3.10.200.6.2.1.1.1.1.28", ISnmpConstant.INTEGER));
  }
...
//    return (String) getProperty(utsEponModuleBoard2424Information).getValue();
  ...
  public boolean retrieve() throws MibBeanException {
    ...
    prepareRead(super.getProperty(utsEponModuleBoardHwVer));
    prepareRead(super.getProperty(utsEponModuleBoardCpldVer));
    prepareRead(super.getProperty(utsEponModuleBoardSerialNumber));
    prepareRead(super.getProperty(utsEponModuleBoard2424Information));
    prepareRead(super.getProperty(utsEponModuleBoardCpuUtil));
    prepareRead(super.getProperty(utsEponModuleBoardMemUtil));
  ...
  public Vector retrieveAll() throws MibBeanException {
    ...
    int i = 0;
    while(i < v.size()) {
      EponModuleBoardTable card = (EponModuleBoardTable)v.get(i);
      if(card.getUtsEponModulePhyPresenceStat() != 1) {//1: installed
        v.remove(i);
      } else {
        i++;
      }
