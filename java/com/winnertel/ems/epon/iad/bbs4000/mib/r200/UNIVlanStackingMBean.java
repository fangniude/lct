...
public class UNIVlanStackingMBean extends SnmpMibBean
{
    ...
    public static final String utsDot3OnuEtherPortVlanTranslation =
        "utsDot3OnuEtherPortVlanTranslation";
    
    public UNIVlanStackingMBean(ISnmpProxy aSnmpProxy)
    {
        super(aSnmpProxy);
        init();
    }
