...
//				ISnmpConstant.INTEGER));
		...
		initProperty(utsDot3Onu2PrivateUniDuplex, new SnmpMibBeanProperty(
				...
				".1.3.6.1.4.1.45121.1800.2.3.1.2.1.102.1.23",
				ISnmpConstant.INTEGER));
