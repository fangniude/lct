...
//            IntfRateControlTable bean = (IntfRateControlTable) v.get(i);
//            int moduleId = bean.getUtsIntfRateControlModuleId();
//            BBS4000CardMibBean cardBean = new BBS4000CardMibBean(fApplication.getSnmpProxy());
//            cardBean.setUtsEponModuleBoardPhyId(moduleId);
//            BeanService.refreshBean(fApplication, cardBean);
//            int moduleType = (cardBean.getUtsEponModuleBoardType() != null) ? cardBean.getUtsEponModuleBoardType() : -1;
//            if (!fModuleType.isEPMModule(moduleType)
//                    && !fModuleType.isGEMModule(moduleType)
//                    && !fModuleType.isEPM04BModule(moduleType)
//                    && !fModuleType.isXGMModule(moduleType)
//                    && !fModuleType.isOSMModule(moduleType)
//                    && !fModuleType.isGPMModule(moduleType)) {
//                v.remove(i);
//            }
//        }
