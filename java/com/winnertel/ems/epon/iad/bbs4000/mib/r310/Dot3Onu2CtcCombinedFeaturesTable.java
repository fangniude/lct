...
public class Dot3Onu2CtcCombinedFeaturesTable extends SnmpMibBean {
    ...
    */
    ...
    public static final String utsDot3Onu2CtcH248RtpTidInfoFirstTidName = "utsDot3Onu2CtcH248RtpTidInfoFirstTidName"; //readOnly
    ...
    */
    ...
    public Dot3Onu2CtcCombinedFeaturesTable(ISnmpProxy aSnmpProxy) {
        super(aSnmpProxy);
        init();
    }

    protected void init() {
        initProperty(utsDot3Onu2CtcCombinedFeaturesModuleId, new SnmpMibBeanProperty(utsDot3Onu2CtcCombinedFeaturesModuleId, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.1", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcCombinedFeaturesDeviceId, new SnmpMibBeanProperty(utsDot3Onu2CtcCombinedFeaturesDeviceId, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.2", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcCombinedFeaturesPortId, new SnmpMibBeanProperty(utsDot3Onu2CtcCombinedFeaturesPortId, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.3", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcCombinedFeaturesLogicalPortId, new SnmpMibBeanProperty(utsDot3Onu2CtcCombinedFeaturesLogicalPortId, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.4", ISnmpConstant.INTEGER));
        /*
        initProperty(utsDot3Onu2CtcMduResetCardCardNumber, new SnmpMibBeanProperty(utsDot3Onu2CtcMduResetCardCardNumber, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.5", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcMduResetCardReset, new SnmpMibBeanProperty(utsDot3Onu2CtcMduResetCardReset, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.6", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcHoldoverAction, new SnmpMibBeanProperty(utsDot3Onu2CtcHoldoverAction, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.7", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcHoldoverTime, new SnmpMibBeanProperty(utsDot3Onu2CtcHoldoverTime, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.8", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcActivePonifAdminActivePon, new SnmpMibBeanProperty(utsDot3Onu2CtcActivePonifAdminActivePon, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.9", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcTftpOamCommit, new SnmpMibBeanProperty(utsDot3Onu2CtcTftpOamCommit, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.10", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadInfoMacAddr, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoMacAddr, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.101", ISnmpConstant.MAC_ADDRESS));
        */
        initProperty(utsDot3Onu2CtcIadInfoSupportedProtocol, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoSupportedProtocol, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.102", ISnmpConstant.INTEGER));
        /*
		initProperty(utsDot3Onu2CtcIadInfoSoftwareVer, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoSoftwareVer, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.103", ISnmpConstant.STRING));
		initProperty(utsDot3Onu2CtcIadInfoSoftwareDate, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoSoftwareDate, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.104", ISnmpConstant.STRING));
		initProperty(utsDot3Onu2CtcIadInfoVoipUserCount, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoVoipUserCount, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.105", ISnmpConstant.INTEGER));
        */
        initProperty(utsDot3Onu2CtcIadIpMode, new SnmpMibBeanProperty(utsDot3Onu2CtcIadIpMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.131", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadIpAddr, new SnmpMibBeanProperty(utsDot3Onu2CtcIadIpAddr, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.132", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcIadNetMask, new SnmpMibBeanProperty(utsDot3Onu2CtcIadNetMask, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.133", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcIadDefaultGw, new SnmpMibBeanProperty(utsDot3Onu2CtcIadDefaultGw, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.134", ISnmpConstant.IP_ADDRESS));
        //initProperty(utsDot3Onu2CtcIadPppoeMode, new SnmpMibBeanProperty(utsDot3Onu2CtcIadPppoeMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.135", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadPppoeUsername, new SnmpMibBeanProperty(utsDot3Onu2CtcIadPppoeUsername, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.136", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcIadPppoePassword, new SnmpMibBeanProperty(utsDot3Onu2CtcIadPppoePassword, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.137", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcIadTagMode, new SnmpMibBeanProperty(utsDot3Onu2CtcIadTagMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.138", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadCvlan, new SnmpMibBeanProperty(utsDot3Onu2CtcIadCvlan, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.139", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadSvlan, new SnmpMibBeanProperty(utsDot3Onu2CtcIadSvlan, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.140", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcIadPriority, new SnmpMibBeanProperty(utsDot3Onu2CtcIadPriority, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.141", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248MgPort, new SnmpMibBeanProperty(utsDot3Onu2CtcH248MgPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.161", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248MgcIp, new SnmpMibBeanProperty(utsDot3Onu2CtcH248MgcIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.162", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcH248MgpComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcH248MgpComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.163", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248BackupMgcIp, new SnmpMibBeanProperty(utsDot3Onu2CtcH248BackupMgcIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.164", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcH248BackupMgcComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcH248BackupMgcComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.165", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcH248ActiveMgc, new SnmpMibBeanProperty(utsDot3Onu2CtcH248ActiveMgc, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.166", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RegMode, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RegMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.167", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248Mid, new SnmpMibBeanProperty(utsDot3Onu2CtcH248Mid, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.168", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcH248HeartbeatMode, new SnmpMibBeanProperty(utsDot3Onu2CtcH248HeartbeatMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.169", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248HeartbeatCycle, new SnmpMibBeanProperty(utsDot3Onu2CtcH248HeartbeatCycle, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.170", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248HeartbeatCount, new SnmpMibBeanProperty(utsDot3Onu2CtcH248HeartbeatCount, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.171", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidNum, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidNum, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.201", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.202", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.203", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidMode, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidMode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.204", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitLength, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitLength, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.205", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcH248RtpTidInfoFirstTidName, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidInfoFirstTidName, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.231", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcSipMgPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipMgPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.261", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipProxyServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipProxyServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.262", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcSipProxyServComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipProxyServComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.263", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipBackupProxyServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupProxyServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.264", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcSipBackupProxyServComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupProxyServComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.265", ISnmpConstant.INTEGER));
        //initProperty(utsDot3Onu2CtcSipActiveProxyServ, new SnmpMibBeanProperty(utsDot3Onu2CtcSipActiveProxyServ, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.266", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcSipRegServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipRegServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.267", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcSipRegServComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipRegServComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.268", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipBackupRegServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupRegServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.269", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcSipBackupRegServComPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupRegServComPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.270", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipOutBoundServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipOutBoundServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.271", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3Onu2CtcSipOutBoundServPort, new SnmpMibBeanProperty(utsDot3Onu2CtcSipOutBoundServPort, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.272", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipRegInterval, new SnmpMibBeanProperty(utsDot3Onu2CtcSipRegInterval, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.273", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipHeartbeatSwitch, new SnmpMibBeanProperty(utsDot3Onu2CtcSipHeartbeatSwitch, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.274", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipHeartbeatCycle, new SnmpMibBeanProperty(utsDot3Onu2CtcSipHeartbeatCycle, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.275", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcSipHeartbeatCount, new SnmpMibBeanProperty(utsDot3Onu2CtcSipHeartbeatCount, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.276", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcFaxmodemCfgT38Mode, new SnmpMibBeanProperty(utsDot3Onu2CtcFaxmodemCfgT38Mode, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.301", ISnmpConstant.INTEGER));
        initProperty(utsDot3Onu2CtcFaxmodemCfgCtrl, new SnmpMibBeanProperty(utsDot3Onu2CtcFaxmodemCfgCtrl, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.302", ISnmpConstant.INTEGER));
        /*
		initProperty(utsDot3Onu2CtcH248IadOperationStaus, new SnmpMibBeanProperty(utsDot3Onu2CtcH248IadOperationStaus, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.331", ISnmpConstant.INTEGER));
		initProperty(utsDot3Onu2CtcIadOperation, new SnmpMibBeanProperty(utsDot3Onu2CtcIadOperation, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.332", ISnmpConstant.INTEGER));
        */
        initProperty(utsDot3Onu2CtcSipDigitMap, new SnmpMibBeanProperty(utsDot3Onu2CtcSipDigitMap, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.361", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcConfiguredVoipProtocol, new SnmpMibBeanProperty(utsDot3Onu2CtcConfiguredVoipProtocol, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.401", ISnmpConstant.INTEGER));
    }
    ...
    */
    ...
    public void setUtsDot3Onu2CtcIadDefaultGw(String aUtsDot3Onu2CtcIadDefaultGw) {
        getProperty(utsDot3Onu2CtcIadDefaultGw).setValue(
                aUtsDot3Onu2CtcIadDefaultGw);
    }
    ...
    */
    ...
    public void setUtsDot3Onu2CtcIadPppoeUsername(String aUtsDot3Onu2CtcIadPppoeUsername) {
        ...
        /*
        aUtsDot3Onu2CtcIadPppoeUsername = aUtsDot3Onu2CtcIadPppoeUsername.trim();
        if (aUtsDot3Onu2CtcIadPppoeUsername == null) {
            String name = "                                                         ";
            getProperty(utsDot3Onu2CtcIadPppoeUsername).setValue(name.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoeUsername.length() > 32) {
            getProperty(utsDot3Onu2CtcIadPppoeUsername).setValue(aUtsDot3Onu2CtcIadPppoeUsername.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoeUsername.length() < 32) {
            String name = "                                ";
            aUtsDot3Onu2CtcIadPppoeUsername = aUtsDot3Onu2CtcIadPppoeUsername + name.toString();
            getProperty(utsDot3Onu2CtcIadPppoeUsername).setValue(aUtsDot3Onu2CtcIadPppoeUsername.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoeUsername.length() == 32) {
            getProperty(utsDot3Onu2CtcIadPppoeUsername).setValue(aUtsDot3Onu2CtcIadPppoeUsername);
        }
    ...
    public void setUtsDot3Onu2CtcIadPppoePassword(String aUtsDot3Onu2CtcIadPppoePassword) {
        ...
        /*
        aUtsDot3Onu2CtcIadPppoePassword = aUtsDot3Onu2CtcIadPppoePassword.trim();
        if (aUtsDot3Onu2CtcIadPppoePassword == null) {
            String name = "                                                         ";
            getProperty(utsDot3Onu2CtcIadPppoePassword).setValue(name.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoePassword.length() > 32) {
            getProperty(utsDot3Onu2CtcIadPppoePassword).setValue(aUtsDot3Onu2CtcIadPppoePassword.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoePassword.length() < 32) {
            String name = "                                ";
            aUtsDot3Onu2CtcIadPppoePassword = aUtsDot3Onu2CtcIadPppoePassword + name.toString();
            getProperty(utsDot3Onu2CtcIadPppoePassword).setValue(aUtsDot3Onu2CtcIadPppoePassword.substring(0, 32));
        } else if (aUtsDot3Onu2CtcIadPppoePassword.length() == 32) {
            getProperty(utsDot3Onu2CtcIadPppoePassword).setValue(aUtsDot3Onu2CtcIadPppoePassword);
        }
    ...
    */
    ...
    public void setUtsDot3Onu2CtcH248Mid(String aUtsDot3Onu2CtcH248Mid) {
        ...
        /*
        getProperty(utsDot3Onu2CtcH248Mid).setValue(aUtsDot3Onu2CtcH248Mid);
        aUtsDot3Onu2CtcH248Mid = aUtsDot3Onu2CtcH248Mid.trim();
        if (aUtsDot3Onu2CtcH248Mid == null) {
            String name = "                                                         ";
            getProperty(utsDot3Onu2CtcH248Mid).setValue(name.substring(0, 64));
        } else if (aUtsDot3Onu2CtcH248Mid.length() > 64) {
            getProperty(utsDot3Onu2CtcH248Mid).setValue(aUtsDot3Onu2CtcH248Mid.substring(0, 64));
        } else if (aUtsDot3Onu2CtcH248Mid.length() < 64) {
            String name = "                                ";
            aUtsDot3Onu2CtcH248Mid = aUtsDot3Onu2CtcH248Mid + name.toString();
            getProperty(utsDot3Onu2CtcH248Mid).setValue(aUtsDot3Onu2CtcH248Mid.substring(0, 64));
        } else if (aUtsDot3Onu2CtcH248Mid.length() == 64) {
            getProperty(utsDot3Onu2CtcH248Mid).setValue(aUtsDot3Onu2CtcH248Mid);
        }
    ...
    public void setUtsDot3Onu2CtcH248RtpTidCfgTidPrefix(String aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix) {
        ...
        /*
        aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix = aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.trim();
        if (aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix == null) {
            String name = "                                                         ";
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix).setValue(name.substring(0, 16));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.length() > 16) {
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.substring(0, 16));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.length() < 16) {
            String name = "                                ";
            aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix = aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix + name.toString();
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.substring(0, 16));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix.length() == 16) {
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidPrefix).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidPrefix);
        }
    ...
    public Integer getUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin() {
        return (Integer) getProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin).getValue();
    }
    ...
    public void setUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin(Integer aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin) {
        ...
        /*
        aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin = aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.trim();
        if (aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin == null) {
            String name = "                                                         ";
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin).setValue(name.substring(0, 8));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.length() > 8) {
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.substring(0, 8));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.length() < 8) {
            String name = "                                ";
            aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin = aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin + name.toString();
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.substring(0, 8));
        } else if (aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin.length() == 8) {
            getProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin).setValue(aUtsDot3Onu2CtcH248RtpTidCfgTidDigitBegin);
        }
    ...
    */
    ...
    public void setUtsDot3Onu2CtcSipDigitMap(String aUtsDot3Onu2CtcSipDigitMap) {
        ...
        if (aUtsDot3Onu2CtcSipDigitMap == null) {
            getProperty(utsDot3Onu2CtcSipDigitMap).setValue(tmp);
        } else if (aUtsDot3Onu2CtcSipDigitMap.length() < 1024) {
            tmp = (aUtsDot3Onu2CtcSipDigitMap + tmp).substring(0, 1024);
            getProperty(utsDot3Onu2CtcSipDigitMap).setValue(tmp);
        } else if (aUtsDot3Onu2CtcSipDigitMap.length() > 1024) {
            getProperty(utsDot3Onu2CtcSipDigitMap).setValue(aUtsDot3Onu2CtcSipDigitMap.substring(0, 1024));
        } else {
    ...
    public boolean retrieve() throws MibBeanException {
        ...
        */
        prepareRead(getProperty(utsDot3Onu2CtcConfiguredVoipProtocol));
    ...
    public Vector retrieveAll() throws MibBeanException {
        ...
        */
        ...
        Hashtable<String, Dot3Onu2CtcCombinedFeaturesTable> index2SipCfgBean = new Hashtable<String, Dot3Onu2CtcCombinedFeaturesTable>();
        for (int i = 0; i < heartTable.size(); i++) {
            Dot3Onu2CtcCombinedFeaturesTable mBean = (Dot3Onu2CtcCombinedFeaturesTable) heartTable.get(i);
...
//        }
        ...
        for (int i = 0; i < servTable.size(); i++) {
            Dot3Onu2CtcCombinedFeaturesTable mBean = (Dot3Onu2CtcCombinedFeaturesTable) servTable.get(i);
            Integer moduleId = mBean.getUtsDot3Onu2CtcCombinedFeaturesModuleId();
            Integer deviceId = mBean.getUtsDot3Onu2CtcCombinedFeaturesDeviceId();
            Integer portId = mBean.getUtsDot3Onu2CtcCombinedFeaturesPortId();
            Integer logicalId = mBean.getUtsDot3Onu2CtcCombinedFeaturesLogicalPortId();

            Dot3Onu2CtcCombinedFeaturesTable cfgBean = index2SipCfgBean.get(moduleId + "-" + deviceId + "-" + portId + "-" + logicalId);
            ...
            //added by Zhouchao, 2011/8/26
//            if (!DebugMode.isDebug()) {
//                String key = new StringBuilder(neName).append(moduleId).append("/").append(portId).append("/").append(logicalId).toString();
//                if (map != null && map.containsKey(key)) {
//                    mBean.setOnuLabel((String) map.get(key));
//                }
//            }
