...
public class Onu2CtcCombinedFeaturesResetCard extends SnmpMibBean {
    ...
    protected void init() {
        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesModuleId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesModuleId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.1", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesDeviceId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesDeviceId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.2", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesPortId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesPortId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.3", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesLogicalPortId, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcCombinedFeaturesLogicalPortId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.4", ISnmpConstant.INTEGER));

        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcMduResetCardCardNumber, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcMduResetCardCardNumber, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.5", ISnmpConstant.INTEGER));
        initProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcMduResetCardReset, new SnmpMibBeanProperty(Onu2CtcCombinedFeaturesResetCard.utsDot3Onu2CtcMduResetCardReset, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.34.1.6", ISnmpConstant.INTEGER));
    }
