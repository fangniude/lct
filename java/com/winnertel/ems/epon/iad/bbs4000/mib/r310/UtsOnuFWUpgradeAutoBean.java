...
public class UtsOnuFWUpgradeAutoBean extends SnmpMibBean {
    ...
    protected void init() {
	initProperty(utsOnuFWUpgradeAutoPortListBitMap, new SnmpMibBeanProperty(utsOnuFWUpgradeAutoPortListBitMap, ".1.3.6.1.4.1.41355.1800.2.3.1.7.14.1", ISnmpConstant.OCTETS));
	initProperty(utsOnuFWUpgradeAutoOption, new SnmpMibBeanProperty(utsOnuFWUpgradeAutoOption, ".1.3.6.1.4.1.41355.1800.2.3.1.7.14.2", ISnmpConstant.INTEGER));
	initProperty(utsOnuFWUpgradeAutoCurrentStatus, new SnmpMibBeanProperty(utsOnuFWUpgradeAutoCurrentStatus, ".1.3.6.1.4.1.41355.1800.2.3.1.7.14.3", ISnmpConstant.OCTETS));
    }

    public byte[] getUtsOnuFWUpgradeAutoPortListBitMap() {
	return (byte[]) getProperty(utsOnuFWUpgradeAutoPortListBitMap).getValue();
    }

    public void setUtsOnuFWUpgradeAutoPortListBitMap(byte[] aUtsOnuFWUpgradeAutoPortListBitMap) {
	getProperty(utsOnuFWUpgradeAutoPortListBitMap).setValue(aUtsOnuFWUpgradeAutoPortListBitMap);
    }
	...
	getProperty(utsOnuFWUpgradeAutoOption).setValue(aUtsOnuFWUpgradeAutoOption);
    }

    public String getUtsOnuFWUpgradeAutoCurrentStatus() {
	return (String) getProperty(utsOnuFWUpgradeAutoCurrentStatus).getValue();
    }

    public void setUtsOnuFWUpgradeAutoCurrentStatus(String aUtsOnuFWUpgradeAutoCurrentStatus) {
	getProperty(utsOnuFWUpgradeAutoCurrentStatus).setValue(aUtsOnuFWUpgradeAutoCurrentStatus);
    }
