...
public class OnuCtcMulticastCtrlTable extends SnmpMibBean {
    ...
    protected void init() {
        initProperty(utsDot3OnuModuleId, new SnmpMibBeanProperty(utsDot3OnuModuleId, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.1", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuDeviceId, new SnmpMibBeanProperty(utsDot3OnuDeviceId, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.2", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuPortId, new SnmpMibBeanProperty(utsDot3OnuPortId, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.3", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuLogicalPortId, new SnmpMibBeanProperty(utsDot3OnuLogicalPortId, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.4", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuEtherPortIndex, new SnmpMibBeanProperty(utsDot3OnuEtherPortIndex, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.5", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuMCastVlan, new SnmpMibBeanProperty(utsDot3OnuMCastVlan, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.6", ISnmpConstant.INTEGER));
        initProperty(utsDot3OnuMCastGroupStart, new SnmpMibBeanProperty(utsDot3OnuMCastGroupStart, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.7", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3OnuMCastGroupEnd, new SnmpMibBeanProperty(utsDot3OnuMCastGroupEnd, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.8", ISnmpConstant.IP_ADDRESS));
        initProperty(utsDot3OnuAuthType, new SnmpMibBeanProperty(utsDot3OnuAuthType, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.9", ISnmpConstant.INTEGER));
        initProperty(ROW_STATUS, new SnmpMibBeanProperty(ROW_STATUS, ".1.3.6.1.4.1.41355.1800.2.4.3.1.1.1.10", ISnmpConstant.INTEGER));
    }
