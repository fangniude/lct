...
//        int card = getUtsPonTrunckProtectionPort1ModuleId();
//        int port = (Integer) getProperty(utsPonTrunckProtectionPort1PortId).getValue();
//        return card + "/" + port;
...
//        int card = getUtsPonTrunckProtectionPort2ModuleId();
//        int port = (Integer) getProperty(utsPonTrunckProtectionPort2PortId).getValue();
//        return card + "/" + port;
