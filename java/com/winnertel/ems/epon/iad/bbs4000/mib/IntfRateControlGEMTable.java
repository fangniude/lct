 ...
 */
public class IntfRateControlGEMTable  extends SnmpMibBean
{
...
//	public static final String utsIntfRateControlMaxFrameSize = "utsIntfRateControlMaxFrameSize";
	...
	public IntfRateControlGEMTable(ISnmpProxy aSnmpProxy)
	{
		super(aSnmpProxy);
		init();
	}
	...
	protected void init()
	{
		...
		initProperty(utsIntfRateControlPortId,
				new SnmpMibBeanProperty(utsIntfRateControlPortId,
						...
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlMcastEnable,
				new SnmpMibBeanProperty(utsIntfRateControlMcastEnable,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.3",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlMcastLimit,
				new SnmpMibBeanProperty(utsIntfRateControlMcastLimit,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.4",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlBcastEnable,
				new SnmpMibBeanProperty(utsIntfRateControlBcastEnable,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.5",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlBcastLimit,
				new SnmpMibBeanProperty(utsIntfRateControlBcastLimit,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.6",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlUnicastEnable,
				new SnmpMibBeanProperty(utsIntfRateControlUnicastEnable,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.7",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlUnicastLimit,
				new SnmpMibBeanProperty(utsIntfRateControlUnicastLimit,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.8",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateLimitIngressBandwidth,
				new SnmpMibBeanProperty(utsIntfRateLimitIngressBandwidth,
						".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.9",
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateLimitEgressBandwidth, new SnmpMibBeanProperty(
				utsIntfRateLimitEgressBandwidth,
				".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.10",
				ISnmpConstant.INTEGER));
//		initProperty(utsIntfRateControlMaxFrameSize, new SnmpMibBeanProperty(
//				utsIntfRateControlMaxFrameSize,
//				".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.11",
//				ISnmpConstant.INTEGER));
		initProperty(utsIntfRateControlIsolationCtrl, new SnmpMibBeanProperty(
				utsIntfRateControlIsolationCtrl,
				".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.12",
				ISnmpConstant.INTEGER));
		...
		initProperty(utsIntfRateControlAutoNegotiation,
				new SnmpMibBeanProperty(utsIntfRateControlAutoNegotiation,
						...
						ISnmpConstant.INTEGER));
		initProperty(utsIntfRateLimitIngressBurstSize, new SnmpMibBeanProperty(
				utsIntfRateLimitIngressBurstSize,
				".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.17",
				ISnmpConstant.INTEGER));
		initProperty(utsIntfRateLimitEgressBurstSize, new SnmpMibBeanProperty(
				utsIntfRateLimitEgressBurstSize,
				".1.3.6.1.4.1.41355.1800.2.2.1.5.3.1.1.18",
				ISnmpConstant.INTEGER));
  ...
  public Integer getIfIndex() {
	...
	public void setUtsIntfRateControlMcastEnable(
			Integer aUtsIntfRateControlMcastEnable)
	{
		getProperty(utsIntfRateControlMcastEnable).setValue(
				aUtsIntfRateControlMcastEnable);
	}
	...
	public void setUtsIntfRateControlMcastLimit(
			Integer aUtsIntfRateControlMcastLimit)
	{
		getProperty(utsIntfRateControlMcastLimit).setValue(
				aUtsIntfRateControlMcastLimit);
	}
	...
	public void setUtsIntfRateControlBcastEnable(
			Integer aUtsIntfRateControlBcastEnable)
	{
		getProperty(utsIntfRateControlBcastEnable).setValue(
				aUtsIntfRateControlBcastEnable);
	}
	...
	public void setUtsIntfRateControlBcastLimit(
			Integer aUtsIntfRateControlBcastLimit)
	{
		getProperty(utsIntfRateControlBcastLimit).setValue(
				aUtsIntfRateControlBcastLimit);
	}

	public Integer getUtsIntfRateControlUnicastEnable()
	{
		return (Integer) getProperty(utsIntfRateControlUnicastEnable)
				.getValue();
	}

	public void setUtsIntfRateControlUnicastEnable(
			Integer aUtsIntfRateControlUnicastEnable)
	{
		getProperty(utsIntfRateControlUnicastEnable).setValue(
				aUtsIntfRateControlUnicastEnable);
	}
	...
	public void setUtsIntfRateControlUnicastLimit(
			Integer aUtsIntfRateControlUnicastLimit)
	{
		getProperty(utsIntfRateControlUnicastLimit).setValue(
				aUtsIntfRateControlUnicastLimit);
	}

	public Integer getUtsIntfRateLimitIngressBandwidth()
	{
		return (Integer) getProperty(utsIntfRateLimitIngressBandwidth)
				.getValue();
	}

	public void setUtsIntfRateLimitIngressBandwidth(
			Integer aUtsIntfRateLimitIngressBandwidth)
	{
		getProperty(utsIntfRateLimitIngressBandwidth).setValue(
				aUtsIntfRateLimitIngressBandwidth);
	}

	public Integer getUtsIntfRateLimitEgressBandwidth()
	{
		return (Integer) getProperty(utsIntfRateLimitEgressBandwidth)
				.getValue();
	}

	public void setUtsIntfRateLimitEgressBandwidth(
			Integer aUtsIntfRateLimitEgressBandwidth)
	{
		getProperty(utsIntfRateLimitEgressBandwidth).setValue(
				aUtsIntfRateLimitEgressBandwidth);
	}
...
//	}
//
//	public void setUtsIntfRateControlMaxFrameSize(
//			Integer aUtsIntfRateControlMaxFrameSize)
//	{
//		getProperty(utsIntfRateControlMaxFrameSize).setValue(
//				aUtsIntfRateControlMaxFrameSize);
//	}
//
	public Integer getUtsIntfRateControlIsolationCtrl()
	{
		return (Integer) getProperty(utsIntfRateControlIsolationCtrl)
				.getValue();
	}

	public void setUtsIntfRateControlIsolationCtrl(
			Integer aUtsIntfRateControlIsolationCtrl)
	{
		getProperty(utsIntfRateControlIsolationCtrl).setValue(
				aUtsIntfRateControlIsolationCtrl);
	}
	...
	{
		return (Integer) getProperty(utsIntfRateLimitIngressBurstSize)
				.getValue();
	}

	public void setUtsIntfRateLimitIngressBurstSize(
			Integer aUtsIntfRateLimitIngressBurstSize)
	{
		getProperty(utsIntfRateLimitIngressBurstSize).setValue(
				aUtsIntfRateLimitIngressBurstSize);
	}

	public Integer getUtsIntfRateLimitEgressBurstSize()
	{
		return (Integer) getProperty(utsIntfRateLimitEgressBurstSize)
				.getValue();
	}

	public void setUtsIntfRateLimitEgressBurstSize(
			Integer aUtsIntfRateLimitEgressBurstSize)
	{
		getProperty(utsIntfRateLimitEgressBurstSize).setValue(
				aUtsIntfRateLimitEgressBurstSize);
	}

	public boolean retrieve() throws MibBeanException
	{
		prepareRead(super.getProperty(utsIntfRateControlMcastEnable));
		prepareRead(super.getProperty(utsIntfRateControlMcastLimit));
		prepareRead(super.getProperty(utsIntfRateControlBcastEnable));
		prepareRead(super.getProperty(utsIntfRateControlBcastLimit));
		prepareRead(super.getProperty(utsIntfRateControlUnicastEnable));
		prepareRead(super.getProperty(utsIntfRateControlUnicastLimit));
		prepareRead(super.getProperty(utsIntfRateLimitIngressBandwidth));
		prepareRead(super.getProperty(utsIntfRateLimitEgressBandwidth));
//		prepareRead(super.getProperty(utsIntfRateControlMaxFrameSize));
		prepareRead(super.getProperty(utsIntfRateControlIsolationCtrl));
		...
		prepareRead(super.getProperty(utsIntfRateLimitIngressBurstSize));
		prepareRead(super.getProperty(utsIntfRateLimitEgressBurstSize));
