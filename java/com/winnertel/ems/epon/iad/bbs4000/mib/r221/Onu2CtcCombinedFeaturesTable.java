...
public class Onu2CtcCombinedFeaturesTable extends SnmpMibBean {
    ...
    protected void init() {
        ...
        initProperty(utsDot3Onu2CtcIadInfoMacAddr, new SnmpMibBeanProperty(utsDot3Onu2CtcIadInfoMacAddr, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.101", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcIadIpAddr, new SnmpMibBeanProperty(utsDot3Onu2CtcIadIpAddr, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.132", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcIadNetMask, new SnmpMibBeanProperty(utsDot3Onu2CtcIadNetMask, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.133", ISnmpConstant.STRING));
        initProperty(utsDot3Onu2CtcIadDefaultGw, new SnmpMibBeanProperty(utsDot3Onu2CtcIadDefaultGw, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.134", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcH248MgcIp, new SnmpMibBeanProperty(utsDot3Onu2CtcH248MgcIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.162", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcH248BackupMgcIp, new SnmpMibBeanProperty(utsDot3Onu2CtcH248BackupMgcIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.164", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, new SnmpMibBeanProperty(utsDot3Onu2CtcH248RtpTidCfgTidDigitBegin, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.203", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcSipProxyServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipProxyServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.262", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcSipBackupProxyServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupProxyServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.264", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcSipRegServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipRegServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.267", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcSipBackupRegServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipBackupRegServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.269", ISnmpConstant.STRING));
        ...
        initProperty(utsDot3Onu2CtcSipOutBoundServIp, new SnmpMibBeanProperty(utsDot3Onu2CtcSipOutBoundServIp, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.34.1.271", ISnmpConstant.STRING));
