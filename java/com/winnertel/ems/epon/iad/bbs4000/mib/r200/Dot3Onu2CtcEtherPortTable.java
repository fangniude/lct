...
/**
 * The Dot3Onu2CtcEtherPortTable class. Created by QuickDVM
 */
public class Dot3Onu2CtcEtherPortTable extends SnmpMibBean {
	...
	protected void init() {
		...
		initProperty(utsDot3OnuEtherPortIndex, new SnmpMibBeanProperty(
				...
				ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortPhyAdminState, new SnmpMibBeanProperty(
				utsDot3OnuEtherPortPhyAdminState,
				".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.6",
				ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortPhyAdminCtrl, new SnmpMibBeanProperty(
				...
				ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortAutoNegAdminSt,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortAutoNegAdminSt,
						".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.8",
						ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortAutoNegLocTec,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortAutoNegLocTec,
						".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.9",
						ISnmpConstant.OCTETS));
		initProperty(utsDot3OnuEtherPortAutoNegAbility,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortAutoNegAbility,
						".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.10",
						ISnmpConstant.OCTETS));
		initProperty(utsDot3OnuEtherPortAutoNegRestart,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortAutoNegRestart,
						".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.11",
						ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortAutoNegAdminCtrl,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortAutoNegAdminCtrl,
						...
						ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortLinkState, new SnmpMibBeanProperty(
				utsDot3OnuEtherPortLinkState,
				".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.30",
				ISnmpConstant.INTEGER));
		initProperty(utsDot3OnuEtherPortClassifiRuleClear,
				new SnmpMibBeanProperty(utsDot3OnuEtherPortClassifiRuleClear,
						".1.3.6.1.4.1.41355.1800.2.3.1.2.1.11.1.46",
						ISnmpConstant.INTEGER));
	...
	public Integer getUtsDot3OnuEtherPortPhyAdminState() {
		return (Integer) getProperty(utsDot3OnuEtherPortPhyAdminState)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortPhyAdminState(
			Integer aUtsDot3OnuEtherPortPhyAdminState) {
		getProperty(utsDot3OnuEtherPortPhyAdminState).setValue(
				aUtsDot3OnuEtherPortPhyAdminState);
	}
	...
	public Integer getUtsDot3OnuEtherPortAutoNegAdminSt() {
		return (Integer) getProperty(utsDot3OnuEtherPortAutoNegAdminSt)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortAutoNegAdminSt(
			Integer aUtsDot3OnuEtherPortAutoNegAdminSt) {
		getProperty(utsDot3OnuEtherPortAutoNegAdminSt).setValue(
				aUtsDot3OnuEtherPortAutoNegAdminSt);
	}

	public byte[] getUtsDot3OnuEtherPortAutoNegLocTec() {
		return (byte[]) getProperty(utsDot3OnuEtherPortAutoNegLocTec)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortAutoNegLocTec(
			byte[] aUtsDot3OnuEtherPortAutoNegLocTec) {
		getProperty(utsDot3OnuEtherPortAutoNegLocTec).setValue(
				aUtsDot3OnuEtherPortAutoNegLocTec);
	}

	public byte[] getUtsDot3OnuEtherPortAutoNegAbility() {
		return (byte[]) getProperty(utsDot3OnuEtherPortAutoNegAbility)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortAutoNegAbility(
			byte[] aUtsDot3OnuEtherPortAutoNegAbility) {
		getProperty(utsDot3OnuEtherPortAutoNegAbility).setValue(
				aUtsDot3OnuEtherPortAutoNegAbility);
	}

	public Integer getUtsDot3OnuEtherPortAutoNegRestart() {
		return (Integer) getProperty(utsDot3OnuEtherPortAutoNegRestart)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortAutoNegRestart(
			Integer aUtsDot3OnuEtherPortAutoNegRestart) {
		getProperty(utsDot3OnuEtherPortAutoNegRestart).setValue(
				aUtsDot3OnuEtherPortAutoNegRestart);
	}
	...
	public void setUtsDot3OnuEtherPortLinkState(
			Integer aUtsDot3OnuEtherPortLinkState) {
		getProperty(utsDot3OnuEtherPortLinkState).setValue(
				aUtsDot3OnuEtherPortLinkState);
	}

	public Integer getUtsDot3OnuEtherPortClassifiRuleClear() {
		return (Integer) getProperty(utsDot3OnuEtherPortClassifiRuleClear)
				.getValue();
	}

	public void setUtsDot3OnuEtherPortClassifiRuleClear(
			Integer aUtsDot3OnuEtherPortClassifiRuleClear) {
		getProperty(utsDot3OnuEtherPortClassifiRuleClear).setValue(
				aUtsDot3OnuEtherPortClassifiRuleClear);
	}
