...
public class MockIADManager /*implements IADMainInf*/ {
    ...
    String host = "10.4.33.224";
    String swVersion = "3.3.0";
    String country = "US";
    String language = "en";
    ...
    public void setSwVersion(String ver) {
        swVersion = ver;
    }
...
//        DebugMode.setDebug(true);
        ...
        frameParamMap.put("neType", "FBW3000");
        ...
        frameParamMap.setProperty("swVersion", swVersion);
        frameParamMap.setProperty("MoNameList", "FBW3000");
        frameParamMap.setProperty("FocusMoName", "FBW3000");
    ...
    public void showDVM() {
        ...
        //setVisible(false);
        String title = "BBS1000+ Debug - " + this.host;
