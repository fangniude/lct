...
import com.winnertel.ems.epon.iad.bbs1000.mib.QosExtDscpTrustTable;
...
public class QosExtDscpTrustTablePanel extends UPanel
{
	...
	public void refresh()
	{
		...
		tfUtsMLSQosExtDscpTrustMode.setSelectedIndex(getIndexFromValue(utsMLSQosExtDscpTrustModeVList, mbean.getUtsMLSQosExtDscpTrustMode().intValue()));
		tfUtsMLSQosExtDscpTrustIntfQosCtrl.setSelectedIndex(getIndexFromValue(utsMLSQosExtDscpTrustIntfQosCtrlVList, mbean.getUtsMLSQosExtDscpTrustIntfQosCtrl().intValue()));
	}
	...
	public void updateModel()
	{
		...
		mbean.setUtsMLSQosExtDscpTrustMode(new Integer(utsMLSQosExtDscpTrustModeVList[tfUtsMLSQosExtDscpTrustMode.getSelectedIndex()]));
		mbean.setUtsMLSQosExtDscpTrustIntfQosCtrl(new Integer(utsMLSQosExtDscpTrustIntfQosCtrlVList[tfUtsMLSQosExtDscpTrustIntfQosCtrl.getSelectedIndex()]));
	}
