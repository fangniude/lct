...
public class OnuSelectiveQinQPanel extends UPanel implements ActionListener {
    ...
    public void initGui() {
        ...
        NTLayout layout = new NTLayout(8, 3, NTLayout.FILL, NTLayout.CENTER, 5, 5); //modified by Zhou Chao, 2008/8/9
        ...
        int split = new BBS1000NE(fApplication).getPonSplitRatio();
    ...
    public boolean validateFrom() {
        ...
        int cos = cbUtsDot3OnuSelectiveQinQCos.isSelected() ? tfUtsDot3OnuSelectiveQinQCos.getValue() : 8;
        int startCVID = cbUtsDot3OnuSelectiveQinQStartCVID.isSelected()? tfUtsDot3OnuSelectiveQinQStartCVID.getValue() : 4095;
        int endCVID = cbUtsDot3OnuSelectiveQinQEndCVID.isSelected()? tfUtsDot3OnuSelectiveQinQEndCVID.getValue() : 4095;
        SnmpTableModel model = (SnmpTableModel)fTable.getModel();
        for(int i = 0; i < model.getRowCount(); i++) {
            OnuSelectiveQinQMBean mbean = (OnuSelectiveQinQMBean)model.getRow(i);

            if(mbean.getUtsDot3OnuSelectiveQinQModuleId().equals(new Integer((String)tfUtsDot3OnuSelectiveQinQModuleId.getSelectedItem())) &&
                    mbean.getUtsDot3OnuSelectiveQinQPortId().equals(new Integer((String)tfUtsDot3OnuSelectiveQinQPortId.getSelectedItem())) &&
                    mbean.getUtsDot3OnuSelectiveQinQLogicalPortId().equals(new Integer((String)tfUtsDot3OnuSelectiveQinQLogicalPortId.getSelectedItem())) &&
                    mbean.getUtsDot3OnuSelectiveQinQCos().equals(cos) && mbean.getUtsDot3OnuSelectiveQinQStartCVID().equals(startCVID) &&
                    mbean.getUtsDot3OnuSelectiveQinQEndCVID().equals(endCVID)) {

                String error = fStringMap.getString("Err_Index_Exist");
                MessageDialog.showErrorMessageDialog(fApplication, error);
    ...
    public void updateModel() { //modified by Zhou Chao, 2008/8/8
        ...
        if (SnmpAction.IType.ADD.equals(fCommand)) {
            ...
            iValue = 0x0; //iValue = Integer.parseInt("0", 16);
