...
import com.winnertel.ems.epon.iad.bbs4000.gui.swing.RetrieveWorker;
...
public class BBS1000OnuTablePane extends CustomTablePanel implements ActionListener {
    private ILogger fLogger = LoggerController.createLogger(BBS4000OnuTablePane.class);
    protected BBS1000OnuFilterPanel filterPane = null;
    protected SnmpTablePane snmpPanel;
    protected JButton refreshButton;
    private RetrieveWorker retrieveWorker;

    public BBS1000OnuTablePane(IApplication app) {
        super(app);
        init();
    }
    ...
    private String[] getIndex(String panel) {
        ...
        if (panel.equals("OnuSelectiveQinQ_Panel")) {
            ...
            //          index[5] = "0";
                ...
                || panel.equals("UNIMulticastConfigure_Panel") || panel.equals("VlanModeConfigMBean_Panel")//
                || panel.equals("Dot3Onu2CtcEtherPortRateTable_Panel") || panel.equals("Dot3Onu2CtcPortsCftTable_Panel")//
                || panel.equals("Onu2CtcPotsCfgTable_Panel") || panel.equals("UNIDataServiceMBean_Panel")//
                || panel.equals("UNIIPTVServiceMBean_Panel") || panel.equals("Dot3Onu2CtcLpbkDetectTable_Panel")) {
            index = new String[5];
    ...
    public BBS1000OnuFilterPanel getFilterPane() {
        return filterPane;
    }
}
