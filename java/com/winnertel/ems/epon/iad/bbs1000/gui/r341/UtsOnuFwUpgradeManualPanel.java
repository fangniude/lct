...
import com.winnertel.ems.epon.iad.bbs1000.mib.r341.UtsOnuFWUpgradeManualBean;
...
public class UtsOnuFwUpgradeManualPanel extends UPanel {
	...
	private String[] utsOnuFWUpgradeManualOptionTList = new String[] {
			fStringMap.getString("normal"), // 1
			fStringMap.getString("force"), // 2
	};
	private JComboBox tfUtsOnuFWUpgradeManualOption = new JComboBox(
			utsOnuFWUpgradeManualOptionTList);

	private int[] utsOnuFWUpgradeManualActCommitFlagVList = new int[] { 0, 1, };
	private String[] utsOnuFWUpgradeManualActCommitFlagTList = new String[] {
			fStringMap.getString("activate"), // 1
			fStringMap.getString("activateCommit"), // 2
	};
	private JComboBox tfUtsOnuFWUpgradeManualActCommitFlag = new JComboBox(
			utsOnuFWUpgradeManualActCommitFlagTList);
	...
	private String[] utsOnuFWUpgradeManualManualStopTList = new String[] {
			fStringMap.getString("true"), fStringMap.getString("false"), };
	private JComboBox tfUtsOnuFWUpgradeManualManualStop = new JComboBox(
			utsOnuFWUpgradeManualManualStopTList);

	private final String utsOnuFWUpgradeManualOption = fStringMap
			.getString("utsOnuFWUpgradeManualOption")
			+ " : ";
	private final String utsOnuFWUpgradeManualActCommitFlag = fStringMap
			.getString("utsOnuFWUpgradeManualActCommitFlag")
			+ " : ";
	private final String utsOnuFWUpgradeManualCurrentStatus = fStringMap
			.getString("utsOnuFWUpgradeManualCurrentStatus")
			+ " : ";
	private final String utsOnuFWUpgradeManualPortListBitMap = fStringMap
			.getString("utsOnuFWUpgradeManualPortListBitMap")
			+ " : ";
	private final String utsOnuFWUpgradeManualManualStop = fStringMap
			.getString("utsOnuFWUpgradeManualManualStop");
	...
	protected void initGui() {
		...
		NTLayout layout = new NTLayout(4, 6, NTLayout.FILL, NTLayout.CENTER, 5,
				5);
		...
		tfUtsOnuFWUpgradeManualManualStop.setName(fStringMap
				.getString("utsOnuFWUpgradeManualManualStop"));
	...
	public void updateModel() {
		...
		if (mbean == null)
			return;
		mbean.setUtsOnuFWUpgradeManualPortListBitMap(onuTreePanel
				.getSelectedOnuBitMap());
		...
		mbean
				.setUtsOnuFWUpgradeManualOption(utsOnuFWUpgradeManualOptionVList[tfUtsOnuFWUpgradeManualOption
						.getSelectedIndex()]);
		mbean
				.setUtsOnuFWUpgradeManualActCommitFlag(utsOnuFWUpgradeManualActCommitFlagVList[tfUtsOnuFWUpgradeManualActCommitFlag
						.getSelectedIndex()]);
	...
	private boolean checkPermission(String anActionId) {
		if (fApplication.isDebug() || anActionId == null
				|| anActionId.length() == 0) {
			return true;
		}
