...
/**
 * The Dot3Olt2AclConfTablePanel class.
...
//  private JComboBox tfUtsDot3OltAclConfDeviceId = null;
  ...
  private int[] utsDot3OltAclConfDirectionVList = new int[]{
    1, 2, };
  private String[] utsDot3OltAclConfDirectionTList = new String[]{
    fStringMap.getString("upstream"),
    fStringMap.getString("downstream"),
  };
...
//    baseInfoPanel.add(new HSpacer());
    ...
    tfUtsDot3OltAclConfProfId = new JComboBox();
  ...
  public void updateModel() {
    ...
    if (SnmpAction.IType.ADD.equals(fCommand)) setModel(new Dot3Olt2AclConfTable(fApplication.getSnmpProxy()));
