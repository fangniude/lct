...
import com.winnertel.ems.epon.iad.bbs1000.mib.r341.OltVlanBatchConfigScalars;
...
//}
	...
	private Vector getPortList() throws Exception {
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            int moduleBoardType = ((BBS1000CardMibBean) v.get(i)).getUtsEponModuleBoardType();
            int modulePhyPreStat = ((BBS1000CardMibBean) v.get(i)).getUtsEponModuleBoardState();
//            if (moduleType.isLTMModule(moduleBoardType) && modulePhyPreStat == 3) {
