/**
 * Created by Zhou Chao, 2009/1/6
 */

package com.winnertel.ems.epon.iad.bbs1000.gui.r340.action;
...
import com.winnertel.ems.epon.iad.bbs1000.mib.r340.Dot3Onu2CtcTable;
...
public class ResetOnuAction extends SnmpAction {
    ...
    public void executeAction(ActionEvent e) throws OperationFailedException, OperationCanceledException, OperationFinishedWithoutLogException {
        ...
        if (((Dot3Onu2CtcTable) bean).getUtsDot3Onu2CtcRegisterStatus() != 1) {
