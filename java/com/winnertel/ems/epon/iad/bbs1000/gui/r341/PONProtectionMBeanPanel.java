...
//    	tfUtsPonTrunckProtectionName.setLenScope(0, 16);
    ...
    public void refresh() {
        ...
        for(int i = 0; cardList!=null && i < cardList.size(); i++) {
            ...
            if(moduleType.isLTMModule(card.getUtsEponModuleBoardType()) && card.getUtsEponModuleBoardState() == 3) {
                for(int j = 1; j <= 4; j++) {
        ...
        for(int i = 0; i < v.size(); i++) {
        	tfUtsPonTrunckProtectionGroupId.removeItem(((Dot3Olt2PonProtectionMBean) v.get(i)).getUtsPonTrunckProtectionGroupId());
        	tfUtsPonTrunckProtectionPort1Interface.removeItem(((Dot3Olt2PonProtectionMBean) v.get(i)).getUtsPonTrunckProtectionPort1Interface());
        	tfUtsPonTrunckProtectionPort1Interface.removeItem(((Dot3Olt2PonProtectionMBean) v.get(i)).getUtsPonTrunckProtectionPort2Interface());
        	tfUtsPonTrunckProtectionPort2Interface.removeItem(((Dot3Olt2PonProtectionMBean) v.get(i)).getUtsPonTrunckProtectionPort1Interface());
        	tfUtsPonTrunckProtectionPort2Interface.removeItem(((Dot3Olt2PonProtectionMBean) v.get(i)).getUtsPonTrunckProtectionPort2Interface());
        }
    	...
    	if(SnmpAction.IType.MODIFY.equals(fCommand)) {
    		...
    		if(tfUtsPonTrunckProtectionPort1Interface.getItemCount()!= 0) tfUtsPonTrunckProtectionPort1Interface.setSelectedIndex(0);
    		if(tfUtsPonTrunckProtectionPort2Interface.getItemCount()!= 0)  tfUtsPonTrunckProtectionPort2Interface.setSelectedIndex(1);
    	}
