...
import com.winnertel.ems.epon.iad.bbs1000.mib.SwitchPortExtTable;
...
public class SwitchPortExtTablePanel extends UPanel {
  ...
  public void refresh() {
    ...
    tfUtsSwitchPortExtIfNum.setText(SwitchInterfaceIndexFormatter.format(mbean.getUtsSwitchPortExtIfNum()));
    tfUtsSwitchPortExtACLDefAction.setSelectedIndex(getIndexFromValue(utsSwitchPortExtACLDefActionVList, mbean.getUtsSwitchPortExtACLDefAction().intValue()));
    tfUtsSwitchPortExtAdmFlowControlRx.setSelectedIndex(getIndexFromValue(utsSwitchPortExtAdmFlowControlRxVList, mbean.getUtsSwitchPortExtAdmFlowControlRx().intValue()));
    tfUtsSwitchPortExtAdmFlowControlTx.setSelectedIndex(getIndexFromValue(utsSwitchPortExtAdmFlowControlTxVList, mbean.getUtsSwitchPortExtAdmFlowControlTx().intValue()));
    tfUtsSwitchPortExtIpMuticastFilter.setSelectedIndex(getIndexFromValue(utsSwitchPortExtIpMuticastFilterVList, mbean.getUtsSwitchPortExtIpMuticastFilter().intValue()));
  }

  public void updateModel() {
    SwitchPortExtTable mbean = (SwitchPortExtTable) getModel();

    mbean.setUtsSwitchPortExtACLDefAction(new Integer(utsSwitchPortExtACLDefActionVList[tfUtsSwitchPortExtACLDefAction.getSelectedIndex()]));
    mbean.setUtsSwitchPortExtAdmFlowControlRx(new Integer(utsSwitchPortExtAdmFlowControlRxVList[tfUtsSwitchPortExtAdmFlowControlRx.getSelectedIndex()]));
    mbean.setUtsSwitchPortExtAdmFlowControlTx(new Integer(utsSwitchPortExtAdmFlowControlTxVList[tfUtsSwitchPortExtAdmFlowControlTx.getSelectedIndex()]));
    mbean.setUtsSwitchPortExtIpMuticastFilter(new Integer(utsSwitchPortExtIpMuticastFilterVList[tfUtsSwitchPortExtIpMuticastFilter.getSelectedIndex()]));
  }
