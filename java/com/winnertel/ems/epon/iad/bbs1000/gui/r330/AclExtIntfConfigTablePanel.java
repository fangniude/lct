...
public class AclExtIntfConfigTablePanel extends UPanel {
    ...
    void getAllInterface() {
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            int moduleBoardState = ((BBS1000CardMibBean) v.get(i)).getUtsEponModuleBoardState().intValue();
        ...
        com.winnertel.ems.epon.iad.bbs4000.mib.r300.AclExtIntfConfigTable cmbean = new com.winnertel.ems.epon.iad.bbs4000.mib.r300.AclExtIntfConfigTable(fApplication.getSnmpProxy());
        Vector v1 = BeanService.refreshTableBean(fApplication, cmbean);
        if (v1 != null) {
            String[] ids = new String[v1.size()];
            for (int i = 0; i < v1.size(); i++) {
                com.winnertel.ems.epon.iad.bbs4000.mib.r300.AclExtIntfConfigTable one = (com.winnertel.ems.epon.iad.bbs4000.mib.r300.AclExtIntfConfigTable) v1.get(i);
