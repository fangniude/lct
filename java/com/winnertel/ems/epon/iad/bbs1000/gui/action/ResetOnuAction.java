...
public class ResetOnuAction extends SnmpAction {
	...
	public void executeAction(ActionEvent e) throws OperationFailedException,
		...
		if ( ((Dot3Onu2CtcConfigure)bean).getUtsDot3Onu2CtcRegisterStatus().intValue() != 1 ) {
			MessageDialog.showInfoMessageDialog(fApplication,
					fApplication.getActiveDeviceManager().getGuiComposer().getString("Err_Only_Register_ONU_Can_Reset") );
			return;
		}
