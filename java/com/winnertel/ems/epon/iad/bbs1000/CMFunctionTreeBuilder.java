...
public class CMFunctionTreeBuilder extends BaseNodeDecorator {
	...
	public static final String CM_BBS1000_NODE = "BBS1000";
    ...
    private void buildTree(FunctionTreeNode aNode) {
        try {
        	URL url = getClass().getClassLoader().getResource("com/winnertel/ems/epon/iad/bbs1000/CMFunctionTreeNode.xml");
            if (url != null) {
