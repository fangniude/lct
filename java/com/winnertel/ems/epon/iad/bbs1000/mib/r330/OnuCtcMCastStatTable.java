...
public class OnuCtcMCastStatTable extends SnmpMibBean {
  ...
  protected void init() {
    ...
    initProperty(utsDot3OnuMCastStatAverageTime, new SnmpMibBeanProperty(utsDot3OnuMCastStatAverageTime, ".1.3.6.1.4.1.41355.1800.2.4.3.1.7.1.8", ISnmpConstant.INTEGER));
  }
