...
//    public static final String utsDot3OltOpmSwitch = "utsDot3OltOpmSwitch";
...
//      initProperty(utsDot3OltOpmSwitch, new SnmpMibBeanProperty(utsDot3OltOpmSwitch, ".1.3.6.1.4.1.45121.1800.2.3.1.1.3.17.1", ISnmpConstant.INTEGER));
  }
...
//    public Integer getUtsDot3OltOpmSwitch() {
//        return (Integer) getProperty(utsDot3OltOpmSwitch).getValue();
//    }
//
//    public void setUtsDot3OltOpmSwitch(Integer aUtsDot3OltOpmSwitch) {
//        getProperty(utsDot3OltOpmSwitch).setValue(aUtsDot3OltOpmSwitch);
//    }
...
//      prepareRead(getProperty(utsDot3OltOpmSwitch));
...
//          prepareSave(getProperty(utsDot3OltOpmSwitch));
