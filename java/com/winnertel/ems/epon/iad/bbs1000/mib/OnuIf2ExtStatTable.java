...
/**
 * The PonIf2ExtStatTable class.
 * Created by QuickDVM
 */
public class OnuIf2ExtStatTable extends SnmpMibBean {
  ...
  public OnuIf2ExtStatTable(ISnmpProxy aSnmpProxy) {
    super(aSnmpProxy);
    init();
  }
  ...
  public String getIf3Index(){
    return getIndex(0) + "/" + getIndex(2) + "/" + getIndex(3);
  }
  ...
  public Vector retrieveAll() throws MibBeanException {
    ...
    setIndex(0, new Integer(2));
    setIndex(1, new Integer(1));
    setIndex(2, new Integer(4));
    setIndex(3, new Integer(0));
    ...
    while(i < v.size())
    {
      OnuIf2ExtStatTable bean = (OnuIf2ExtStatTable)v.get(i);
