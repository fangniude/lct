...
public class PonVlanTranslationTable extends SnmpMibBean {
  ...
  protected void init() {
    ...
    initProperty(utsPonVlanTranslationOldCos, new SnmpMibBeanProperty(utsPonVlanTranslationOldCos, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.15.1.6", ISnmpConstant.INTEGER));
    initProperty(utsPonVlanTranslationNewVID, new SnmpMibBeanProperty(utsPonVlanTranslationNewVID, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.15.1.7", ISnmpConstant.INTEGER));
    initProperty(utsPonVlanTranslationNewCos, new SnmpMibBeanProperty(utsPonVlanTranslationNewCos, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.15.1.8", ISnmpConstant.INTEGER));
    initProperty(ROW_STATUS, new SnmpMibBeanProperty(ROW_STATUS, ".1.3.6.1.4.1.41355.1800.2.3.1.1.3.15.1.9", ISnmpConstant.INTEGER));
  }
