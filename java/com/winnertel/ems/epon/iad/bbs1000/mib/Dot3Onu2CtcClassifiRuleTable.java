...
public class Dot3Onu2CtcClassifiRuleTable extends SnmpMibBean {
  ...
  protected void init() {
	    initProperty(utsDot3OnuClassifiRuleProfId, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleProfId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.1", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleId, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.2", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleBitMap, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleBitMap, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.3", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDMacOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDMacOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.4", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDMac, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDMac, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.5", ISnmpConstant.MAC_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleDMac2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDMac2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.6", ISnmpConstant.MAC_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleSMacOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSMacOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.7", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSMac, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSMac, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.8", ISnmpConstant.MAC_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleSMac2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSMac2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.9", ISnmpConstant.MAC_ADDRESS));
	    initProperty(utsDot3OnuClassifiRulePriOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRulePriOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.10", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRulePri, new SnmpMibBeanProperty(utsDot3OnuClassifiRulePri, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.11", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRulePri2, new SnmpMibBeanProperty(utsDot3OnuClassifiRulePri2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.12", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleVlanOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleVlanOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.13", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleVlanId, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleVlanId, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.14", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleVlanId2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleVlanId2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.15", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleTypeOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleTypeOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.16", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleType, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleType, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.17", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleType2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleType2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.18", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSIPOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSIPOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.19", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSIP, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSIP, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.20", ISnmpConstant.IP_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleSIP2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSIP2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.21", ISnmpConstant.IP_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleDIPOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDIPOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.22", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDIP, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDIP, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.23", ISnmpConstant.IP_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleDIP2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDIP2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.24", ISnmpConstant.IP_ADDRESS));
	    initProperty(utsDot3OnuClassifiRuleDSCPOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDSCPOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.25", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDSCP, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDSCP, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.26", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDSCP2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDSCP2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.27", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSPortOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSPortOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.28", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSPort1, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSPort1, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.29", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleSPort2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleSPort2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.30", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDPortOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDPortOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.31", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDPort1, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDPort1, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.32", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleDPort2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleDPort2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.33", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleProtocolOper, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleProtocolOper, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.34", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleProtocol, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleProtocol, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.35", ISnmpConstant.INTEGER));
	    initProperty(utsDot3OnuClassifiRuleProtocol2, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleProtocol2, ".1.3.6.1.4.1.45121.1800.2.3.1.2.1.20.1.36", ISnmpConstant.INTEGER));
  }
  ...
  public Integer getUtsDot3OnuClassifiRuleBitMap() {
    return (Integer) getProperty(utsDot3OnuClassifiRuleBitMap).getValue();
  }

  public void setUtsDot3OnuClassifiRuleBitMap(Integer aUtsDot3OnuClassifiRuleBitMap) {
