...
public class Dot3Onu2CtcClassifiRuleTable extends SnmpMibBean {
  ...
  protected void init() {
	    ...
	    initProperty(utsDot3OnuClassifiRuleBitMap, new SnmpMibBeanProperty(utsDot3OnuClassifiRuleBitMap, ".1.3.6.1.4.1.41355.1800.2.3.1.2.1.20.1.3", ISnmpConstant.INTEGER));
